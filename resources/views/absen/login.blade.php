...
<div class="max-w-md w-full bg-white dark:bg-[#1a1d2e] rounded-2xl shadow-xl overflow-hidden border border-gray-100 dark:border-slate-800" x-data="attendanceLoginForm()">
    <div class="p-8">
        ...
        <form method="POST" action="{{ route('absen.login.post') }}" class="space-y-6" @submit="handleSubmit">
            ...
            @if(!empty($kelas))
                <div class="bg-gray-50 dark:bg-slate-800/50 rounded-xl p-4 border border-gray-100 dark:border-slate-700 space-y-3">
                    ...
                    <div class="flex items-start space-x-3">
                        ...
                        <div class="text-sm">
                            <p class="text-gray-500 dark:text-gray-400 font-medium text-xs uppercase tracking-wider mb-0.5">Metode</p>
            ...
            <div x-show="showReasonFields" x-cloak class="space-y-4">
                <div class="bg-blue-50 border-l-4 border-blue-400 p-3 rounded-r-lg">
                    <p class="text-xs text-blue-700 font-medium">Anda berada di luar radius kampus untuk pertemuan offline. Harap pilih alasan.</p>
                </div>
                ...
                <div x-show="reasonCategory === 'Lainnya'" x-cloak>
                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Detail Alasan <span class="text-red-500">*</span></label>
