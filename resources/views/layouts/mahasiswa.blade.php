...
<head>
    ...
    <title>@yield('title', 'SATU ADHYAKSA - Mahasiswa')</title>

    <!-- Favicon -->
    <link rel="icon" type="image/png" href="{{ asset('images/logo_stih_white.png') }}">

    {{-- Google Fonts — masih dimuat dari CDN. --}}
    ...
    {{-- FontAwesome / SweetAlert2 / jQuery / Alpine (+collapse) di-bundle lokal via Vite. --}}
        ...
        <div class="relative flex flex-col flex-1 min-w-0">
            ...
            <footer class="bg-bg-card border-t border-border-color px-6 py-4 transition-colors duration-200">
                <div class="text-center text-sm text-text-secondary">
                    <p>&copy; {{ date('Y') }} Universitas Adhyaksa. All rights reserved.</p>
                </div>
            </footer>
