...
<div x-show="sidebarOpen" 
    class="fixed inset-0 z-[55] bg-gray-900/50 backdrop-blur-sm lg:hidden transition-opacity duration-300"
...
<!-- Sidebar -->
<aside
    class="fixed inset-y-0 left-0 z-[60] w-64 bg-white dark:bg-[#1f1616] border-r border-[#e6dbdb] dark:border-slate-800 transition-transform duration-300 transform lg:translate-x-0 lg:static lg:inset-0 flex flex-col h-full shadow-2xl lg:shadow-none"
