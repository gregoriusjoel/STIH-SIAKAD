<!-- Sidebar -->
<aside class="w-64 bg-white dark:bg-[#1f1616] border-r border-[#e6dbdb] dark:border-slate-800 hidden lg:flex flex-col h-full">
    <div class="p-6 flex flex-col gap-8 h-full overflow-y-auto">
        <div class="flex items-center gap-3">
            <div class="size-10 rounded-xl bg-gradient-to-br from-primary to-red-900 flex items-center justify-center text-white shadow-lg shadow-primary/20">
