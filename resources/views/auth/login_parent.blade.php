...
<head>
    ...
    <!-- SEO Meta Tags -->
    <meta name="description" content="Portal Login Orang Tua / Wali - SATU ADHYAKSA. Pantau nilai, kehadiran, dan tagihan akademik putra-putri Anda.">
    <meta name="keywords" content="Portal Orang Tua, Wali Mahasiswa, SATU ADHYAKSA, Login Orang Tua, SIAKAD">
    ...
    <meta property="og:title" content="Login Orang Tua / Wali - SATU ADHYAKSA">
    <meta property="og:description" content="Portal Login Orang Tua / Wali - SATU ADHYAKSA.">
    <meta property="og:image" content="{{ asset('images/logo_stih_white.png') }}">

    <!-- Twitter -->
    <meta property="twitter:card" content="summary_large_image">
    <meta property="twitter:url" content="{{ url()->current() }}">
    <meta property="twitter:title" content="Login Orang Tua / Wali - SATU ADHYAKSA">
    <meta property="twitter:description" content="Portal Login Orang Tua / Wali - SATU ADHYAKSA.">
    ...
    <style>
        :root {
            --maroon: #78350f; /* Deep Amber */
            --maroon-light: #b45309; /* Amber/Orange */
            --maroon-dark: #451a03; /* Dark Amber */
    ...
    <div class="login-container">
        <div class="login-card">
            ...
            <div class="header-section">
                <h1>Portal Orang Tua / Wali</h1>
                <p>Silakan masuk untuk memantau perkembangan putra-putri Anda</p>
            </div>
                ...
                <div class="input-group">
                    ...
                    <div class="input-wrapper">
                        <input type="email" name="email" value="{{ old('email') }}" class="input-field"
                            placeholder="orangtua@email.com" required autofocus>
