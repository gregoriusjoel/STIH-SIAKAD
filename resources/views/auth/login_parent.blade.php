...
<head>
    ...
    <!-- SEO Meta Tags -->
    <meta name="description" content="Portal Login Orang Tua / Wali - SATU ADHYAKSA. Pantau hasil studi, tagihan perkuliahan, dan kehadiran anak Anda.">
    <meta name="keywords" content="Portal Orang Tua, SATU ADHYAKSA, Login Wali, SIAKAD">
    <meta name="author" content="SATU ADHYAKSA">
    <meta name="robots" content="index, follow">

    <title>Login Orang Tua / Wali - SATU ADHYAKSA</title>
        ...
        <div class="form-side">
            <div class="form-wrapper">
                ...
                <div class="welcome-header">
                    ...
                    <p>Selamat Datang! Silakan masuk menggunakan kredensial Anda untuk memantau perkembangan akademik anak Anda.</p>
                </div>
                ...
                <form action="{{ route('login.parent.post') }}" method="POST">
                    @csrf
                    
                    <div class="input-group">
                        <div class="input-wrapper">
                            <input type="text" name="email" value="{{ old('email') }}" class="input-field"
                                placeholder="Username atau email orang tua" required autofocus>
        ...
        <div class="feature-side">
            ...
            <div class="mockup-wrapper">
                <div class="illustration-box">
                    <!-- Loading the beautiful Back to school-cuate SVG -->
                    <img src="{{ asset('images/Back to school-cuate.svg') }}" alt="Portal Orang Tua" class="campus-svg-illustration">

                    <!-- Floating Widgets for Parent -->
                    <div class="floating-widget widget-krs">
                        <div class="widget-icon"><i class="fas fa-chart-line"></i></div>
                        <div class="widget-info">
                            <span class="widget-title">Hasil Studi</span>
                            <span class="widget-desc">Nilai & KHS Anak</span>
                        </div>
                    </div>
                    <div class="floating-widget widget-nilai">
                        <div class="widget-icon"><i class="fas fa-user-check"></i></div>
                        <div class="widget-info">
                            <span class="widget-title">Kehadiran Anak</span>
                            <span class="widget-desc">Pantau Presensi</span>
                        </div>
                    </div>
                    <div class="floating-widget widget-jadwal">
                        <div class="widget-icon"><i class="fas fa-credit-card"></i></div>
                        <div class="widget-info">
                            <span class="widget-title">Tagihan Kuliah</span>
                            <span class="widget-desc">Biaya Kuliah</span>
                        </div>
                    </div>
                    <div class="floating-widget widget-dosen">
                        <div class="widget-icon"><i class="fas fa-bell"></i></div>
                        <div class="widget-info">
                            <span class="widget-title">Pengumuman</span>
                            <span class="widget-desc">Info Kampus</span>
                        </div>
                    </div>
                </div>

                <div class="promo-text">
                    <h3>Portal Monitoring Orang Tua</h3>
                    <p>Dapatkan transparansi penuh terkait perkembangan akademik putra-putri Anda, mulai dari daftar nilai semester, kehadiran kuliah, hingga kemudahan pemantauan tagihan.</p>
                </div>
            </div>
        </div>
    </div>
