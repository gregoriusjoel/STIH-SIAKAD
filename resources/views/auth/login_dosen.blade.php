...
<head>
    ...
    <!-- SEO Meta Tags -->
    <meta name="description" content="Portal Login Dosen - SATU ADHYAKSA. Kelola jadwal perkuliahan, absensi, dan nilai mahasiswa.">
    ...
    <meta property="og:title" content="Login Dosen - SATU ADHYAKSA">
    <meta property="og:description" content="Portal Login Dosen - SATU ADHYAKSA.">
    <meta property="og:image" content="{{ asset('images/logo_stih_white.png') }}">

    <!-- Twitter -->
    <meta property="twitter:card" content="summary_large_image">
    <meta property="twitter:url" content="{{ url()->current() }}">
    <meta property="twitter:title" content="Login Dosen - SATU ADHYAKSA">
    <meta property="twitter:description" content="Portal Login Dosen - SATU ADHYAKSA.">
    ...
    <style>
        :root {
            --maroon: #311042; /* Deep Purple */
            --maroon-light: #6b21a8; /* Purple */
            --maroon-dark: #1e072b; /* Dark Purple */
            --accent: #a855f7; /* Purple/Lavender Accent */
        ...
        .submit-btn {
            width: 100%;
            height: 58px;
            background: linear-gradient(135deg, #311042 0%, #6b21a8 100%);
            color: white;
            border: none;
            border-radius: 20px;
            font-size: 16px;
    ...
    <div class="login-container">
        <div class="login-card">
            ...
            <div class="header-section">
                <h1>Portal Dosen</h1>
                <p>Masuk untuk mengelola jadwal perkuliahan & mahasiswa</p>
            </div>
                ...
                <div class="input-group">
                    ...
                    <div class="input-wrapper">
                        <input type="email" name="email" value="{{ old('email') }}" class="input-field"
                            placeholder="dosen@adhyaksa.ac.id" required autofocus>
