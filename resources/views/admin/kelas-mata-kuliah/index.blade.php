                    ...
                    <tbody class="divide-y divide-gray-200">
                        @forelse($kelasMatKul as $k)
                            <tr class="hover:bg-blue-50 transition duration-200 cursor-pointer"
                                ...
                                <td class="px-6 py-4">
                                    <div class="font-semibold text-gray-900">{{ $k->mataKuliah->nama_mk }}</div>
                                ...
                                <td class="px-6 py-4"><span
                                        class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-blue-100 text-blue-800"><i
                                            class="fas fa-users mr-1"></i>{{ $k->nama_kelas }}</span></td>
                                <td class="px-6 py-4">{{ $k->dosen->user->name }}</td>
                                <td class="px-6 py-4">
                                    {{ $k->jadwal?->kelas?->semester_type ?? $k->semester?->nama_semester ?? '-' }}</td>
                                <td class="px-6 py-4">
                                    @if($k->jadwal)
                                        <div class="text-sm">
                                            <div class="font-semibold text-gray-900">{{ $k->jadwal->hari }}</div>
                                            <div class="text-xs text-gray-500">{{ substr($k->jadwal->jam_mulai, 0, 5) }} -
                                                {{ substr($k->jadwal->jam_selesai, 0, 5) }}</div>
                                        </div>
                                    @elseif($k->hari && $k->jam_mulai && $k->jam_selesai)
                                        <div class="text-sm">
                                            <div class="font-semibold text-gray-900">{{ $k->hari }}</div>
                                            <div class="text-xs text-gray-500">{{ substr($k->jam_mulai, 0, 5) }} -
                                                {{ substr($k->jam_selesai, 0, 5) }}</div>
                                        </div>
                                    @else
                                ...
                                <td class="px-6 py-4"><span
                                        class="inline-flex items-center px-2 py-1 rounded text-xs font-medium bg-gray-100 text-gray-800">{{ $k->kapasitas }}</span>
                                </td>
