...
<div class="max-w-4xl mx-auto">
    <div class="bg-white rounded-xl shadow-lg border-t-4 border-blue-600">
        <div class="p-6 border-b border-gray-200 bg-blue-600 text-white rounded-t-xl"><h3 class="text-xl font-bold flex items-center"><i class="fas fa-chalkboard-teacher mr-3 text-2xl"></i>Tambah Kelas Mata Kuliah Baru</h3></div>
