        ...
        <div class="bg-white shadow rounded-lg overflow-hidden">
            ...
            <div class="bg-white border-b p-6">
                <div class="flex items-start gap-6">
                    <div class="flex-shrink-0">
                        <div class="w-16 h-16 rounded-lg bg-maroon text-white flex items-center justify-center text-xl font-bold">
                    ...
                    <div class="flex-shrink-0">
                        <a href="{{ route('admin.users.edit', $user) }}" class="inline-flex items-center gap-2 bg-maroon hover:bg-maroon/90 text-white px-5 py-2.5 rounded-lg text-sm font-medium transition">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" viewBox="0 0 20 20" fill="currentColor">
            ...
            <div class="p-6">
                <div class="mb-5">
                    ...
                    <p class="text-sm text-gray-500 mt-0.5">Rincian dan metadata akun pengguna untuk keperluan administrasi.</p>
                </div>
                ...
                <div class="border-t pt-6">
                    ...
                    <div class="flex flex-wrap items-center gap-2">
                        <a href="{{ route('admin.users.edit', $user) }}" class="inline-flex items-center gap-2 bg-maroon hover:bg-maroon/90 text-white px-4 py-2 rounded-lg text-sm font-medium transition">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" viewBox="0 0 20 20" fill="currentColor">
                                <path d="M17.414 2.586a2 2 0 00-2.828 0L7 10.172V13h2.828l7.586-7.586a2 2 0 000-2.828z"/>
                                <path fill-rule="evenodd" d="M2 6a2 2 0 012-2h4a1 1 0 010 2H4v10h10v-4a1 1 0 112 0v4a2 2 0 01-2 2H4a2 2 0 01-2-2V6z" clip-rule="evenodd"/>
                            </svg>
                        ...
                        <a href="{{ route('admin.users.index') }}" class="inline-flex items-center gap-2 bg-white hover:bg-gray-50 border border-gray-300 text-gray-700 px-4 py-2 rounded-lg text-sm font-medium transition">
                            Kembali
                        </a>
                    </div>
                </div>
