                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <select name="hubungan" 
                                ...
                                <option value="ayah" {{ old('hubungan', $parent->hubungan) == 'ayah' ? 'selected' : '' }}>Ayah</option>
                                <option value="ibu" {{ old('hubungan', $parent->hubungan) == 'ibu' ? 'selected' : '' }}>Ibu</option>
                                <option value="wali" {{ old('hubungan', $parent->hubungan) == 'wali' ? 'selected' : '' }}>Wali</option>
                            </select>
                        </div>
