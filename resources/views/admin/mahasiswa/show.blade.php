...
@section('content')
    <div class="mb-6 flex items-start justify-between">
        ...
        <a href="{{ route('admin.mahasiswa.index') }}"
            class="px-6 py-2.5 bg-white border-2 border-maroon text-maroon rounded-lg font-semibold hover:bg-red-50 hover:border-red-700 shadow-md transition-all duration-200 flex items-center transform hover:scale-105">
            <i class="fas fa-arrow-left mr-2"></i>
            Kembali
        </a>
    </div>

    <div class="bg-white rounded-2xl shadow-xl overflow-hidden" x-data="{ activeTab: 'akademik' }">
        @php
        ...
        {{-- Tabs Header --}}
        <div class="bg-gradient-to-r from-maroon/5 to-red-600/5 border-b border-gray-100 p-6">
            <div class="flex gap-2 overflow-x-auto">
                <button @click="activeTab = 'akademik'"
                    class="px-6 py-2.5 rounded-lg text-sm font-semibold transition-all duration-300 whitespace-nowrap flex items-center gap-2"
                    ...
                    <div class="flex flex-col md:flex-row gap-8 items-start border-b border-gray-100 pb-8">
                        <div class="shrink-0 mx-auto md:mx-0">
                            <div class="border-2 border-gray-100 rounded-lg overflow-hidden bg-gray-50 shadow-sm"
                                ...
                                @if($mahasiswa->foto)
                                    <img src="{{ $mahasiswa->foto_url ?? '' }}" alt="Foto Mahasiswa"
        ...
        : 'Belum diisi' }}
                    ...
                    <div x-data="{ previewOpen: false, previewUrl: '', previewType: '', previewTitle: '' }">
                        <div class="flex items-center justify-between border-b pb-2 mb-4">
                            ...
                            <form action="{{ route('admin.mahasiswa.toggle-dokumen', $mahasiswa) }}" method="POST"
                                class="inline">
                                @csrf
        ...
        : 'bg-green-50 text-green-600 border border-green-200 hover:bg-green-100' }}">
                        ...
                        <div x-show="previewOpen" x-cloak class="fixed inset-0 z-50 flex items-center justify-center p-4"
                            ...
                            <div class="relative bg-white rounded-xl shadow-2xl w-full max-w-4xl max-h-[90vh] flex flex-col overflow-hidden"
                                ...
                                {{-- Header --}}
                                <div
                                    class="flex items-center justify-between px-6 py-4 border-b border-gray-2`00 bg-gray-50 rounded-t-xl">
                                    <div class="flex items-center space-x-3 min-w-0">
                                        <div
                                            class="w-8 h-8 rounded-lg bg-maroon/10 flex items-center justify-center flex-shrink-0">
                                    ...
                                    <div class="flex items-center space-x-2 flex-shrink-0">
                                        <a :href="previewUrl" target="_blank"
                                            ...
                                            <i class="fas fa-external-link-alt md:mr-2"></i><span
                                                class="hidden md:inline">Buka Tab Baru</span>
                                        </a>
                                        <a :href="previewUrl" download
                                            ...
                                            <i class="fas fa-download md:mr-2"></i><span
                                                class="hidden md:inline">Download</span>
                                        </a>
                                ...
                                {{-- Body --}}
                                <div class="flex-1 overflow-auto p-1 bg-gray-100 relative"
                                    style="min-height: 500px; -webkit-overflow-scrolling: touch;">
                                    <template x-if="previewType === 'pdf'">
                                        <iframe :src="previewUrl" class="w-full h-full rounded" style="min-height: 500px;"
                                            frameborder="0"></iframe>
                                    </template>
                                    <template
                                        x-if="['jpg','jpeg','png','gif','webp','svg','bmp'].includes(previewType.toLowerCase())">
                                        <div class="flex items-center justify-center w-full min-h-full"
                                            style="min-height: 500px;">
                                            <img :src="previewUrl" :alt="previewTitle"
                                                class="max-w-full max-h-[78vh] object-contain rounded shadow-sm">
                                        </div>
                                    </template>
                                    <template
                                        x-if="previewType !== 'pdf' && !['jpg','jpeg','png','gif','webp','svg','bmp'].includes(previewType.toLowerCase())">
                                        <div class="flex items-center justify-center w-full min-h-full"
                                            style="min-height: 500px;">
                                            <div class="text-center text-gray-500 py-12">
                                                ...
                                                <a :href="previewUrl" download
                                                    class="mt-3 inline-block text-cyan-600 hover:underline text-sm">
