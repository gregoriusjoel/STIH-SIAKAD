    ...
    <div class="bg-white rounded-xl shadow-lg border-t-4 border-purple-600">
        ...
        <form action="{{ route('admin.semester.store') }}" method="POST" class="p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div><label class="block text-sm font-medium text-gray-700 mb-2"><i class="fas fa-bookmark text-gray-400 mr-1"></i>Nama Semester *</label><input type="text" name="nama_semester" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent transition" placeholder="Semester Ganjil 2023/2024" required></div>
                <div><label class="block text-sm font-medium text-gray-700 mb-2"><i class="fas fa-graduation-cap text-gray-400 mr-1"></i>Tahun Ajaran *</label><input type="text" name="tahun_ajaran" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent transition" placeholder="2023/2024" required></div>
