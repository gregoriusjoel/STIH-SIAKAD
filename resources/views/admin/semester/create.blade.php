        ...
        <form action="{{ route('admin.semester.store') }}" method="POST" class="p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div><label class="block text-sm font-medium text-gray-700 mb-2"><i class="fas fa-bookmark text-gray-400 mr-1"></i>Nama Semester *</label>
                    <select name="nama_semester" id="nama_semester" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent transition" required>
                ...
                <div class="md:col-span-2 flex items-center gap-4">
                    <div class="flex-1">
                        ...
                        <input type="date" name="tanggal_mulai" id="tanggal_mulai" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent transition" required>
                    </div>
                    ...
                    <div class="flex-1">
                        ...
                        <input type="date" name="tanggal_selesai" id="tanggal_selesai" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent transition" required>
                    </div>
                </div>
