            ...
            <form action="{{ route('admin.semester.update', $semester) }}" method="POST" class="p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div><label class="block text-sm font-medium text-gray-700 mb-2"><i
                                class="fas fa-bookmark text-gray-400 mr-1"></i>Nama Semester *</label>
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2"><i
                                class="fas fa-graduation-cap text-gray-400 mr-1"></i>Tahun Ajaran *</label>
                        @php
                    ...
                    <div class="md:col-span-2 flex flex-col md:flex-row items-center gap-4">
                        <div class="flex-1 w-full">
                            <label class="block text-sm font-medium text-gray-700 mb-2"><i
                                    class="fas fa-calendar-alt text-gray-400 mr-1"></i>Tanggal Mulai *</label>
                        ...
                        <div
                            class="text-center text-sm text-gray-500 px-2 py-2 md:py-0 w-full md:w-auto flex justify-center items-center">
                        ...
                        <div class="flex-1 w-full">
                            <label class="block text-sm font-medium text-gray-700 mb-2"><i
                                    class="fas fa-calendar-alt text-gray-400 mr-1"></i>Tanggal Selesai *</label>
                    ...
                    <div class="md:col-span-2">
                        <label class="block text-sm font-medium text-gray-700 mb-2"><i
                                class="fas fa-check-circle text-maroon mr-1"></i>Status *</label>
                        <select name="status"
                            class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent transition"
                            required>
                            <option value="non-aktif" {{ old('status', $semester->status) == 'non-aktif' ? 'selected' : '' }}>
                                Non-Aktif</option>
                            <option value="aktif" {{ old('status', $semester->status) == 'aktif' ? 'selected' : '' }}>Aktif
                            </option>
                        </select>
                        <p class="text-sm text-gray-500 mt-2">Jika dipilih <strong>Aktif</strong>, semester lain akan
                            dinonaktifkan.</p>
                    </div>
                </div>
                <div class="flex justify-end space-x-3 mt-8 pt-6 border-t"><a href="{{ route('admin.semester.index') }}"
