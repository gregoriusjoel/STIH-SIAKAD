            ...
            <div class="p-6">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <div class="mt-4 text-sm text-gray-700 space-y-2">
                            ...
                            <div><strong>Status:</strong> <span
                                    class="px-2 py-1 rounded {{ $dosen->status == 'aktif' ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800' }}">{{ ucfirst($dosen->status) }}</span>
                            </div>
                        </div>
                    </div>
                    <div class="md:col-span-1 flex items-center justify-center">
                        <div
                            class="h-28 w-28 rounded-full bg-maroon flex items-center justify-center text-white font-bold text-2xl">
                ...
                <div class="flex justify-end mt-6">
                    <a href="{{ route('admin.dosen.index') }}"
                        class="px-5 py-2 border rounded text-gray-700 hover:bg-gray-50">Kembali</a>
