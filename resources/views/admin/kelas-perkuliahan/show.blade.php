    ...
    <div class="max-w-4xl mx-auto">
        <div class="mb-6 flex items-center justify-between">
            ...
            <div class="flex gap-2">
                <a href="{{ route('admin.kelas-perkuliahan.edit', $kelasPerkuliahan) }}"
                    class="px-4 py-2 bg-yellow-500 text-white rounded-lg text-sm font-medium hover:bg-yellow-600 transition flex items-center gap-2">
        ...
        <div class="bg-white rounded-xl shadow-lg  overflow-hidden mb-6">
            <div class="p-6 border-b border-gray-200">
                <div class="flex items-center justify-between">
                    ...
                    <span
                        class="inline-flex items-center px-4 py-2 rounded-full text-lg font-black bg-blue-100 text-blue-800">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-0 divide-x divide-gray-200 border-t border-gray-200">
                <div class="p-5">
                    ...
                    <p class="font-semibold text-gray-900">{{ $kelasPerkuliahan->prodi?->nama_prodi ?? 'Belum ditetapkan' }}
                    </p>
                </div>
                <div class="p-5">
                    ...
                    <p class="font-semibold text-gray-900">
                        @if($kelasPerkuliahan->tahunAkademik)
                            {{ $kelasPerkuliahan->tahunAkademik->nama_semester }}
                            {{ $kelasPerkuliahan->tahunAkademik->tahun_ajaran }}
                        @else
                            Tidak terikat
                        @endif
                    </p>
        ...
        <div class="bg-white rounded-xl shadow-lg border-t-4 border-green-500 overflow-hidden">
            <div class="p-5 border-b border-gray-200">
                <h4 class="text-lg font-bold text-gray-800 flex items-center">
                    ...
                    <span
                        class="ml-2 px-2 py-0.5 rounded-full text-xs font-bold bg-green-100 text-green-800">{{ $kelasPerkuliahan->mahasiswas->count() }}</span>
                </h4>
            </div>
