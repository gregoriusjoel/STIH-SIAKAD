        ...
        <select name="action" class="text-sm border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 rounded-lg px-3 py-1.5 focus:ring-2 focus:ring-maroon outline-none">
            ...
            @php
                $actionLabels = [
                    ...
                    'thesis.proposal_submitted' => 'Skripsi: Ajukan Proposal',
                    'thesis.revision_uploaded' => 'Skripsi: Upload Revisi',
                    'thesis.guidance_approved' => 'Skripsi: Setujui Bimbingan',
                    'thesis.revision_approved' => 'Skripsi: ACC Revisi Akhir',
                    'thesis.supervisor_accepted' => 'Skripsi: Terima Pembimbing',
                    'thesis.supervisor_rejected' => 'Skripsi: Tolak Pembimbing',
                ...
                <tr class="hover:bg-gray-50 dark:hover:bg-gray-700 transition">
                    ...
                    <td class="px-4 py-3">
                        ...
                        $actionColors = [
                            ...
                            'thesis.proposal_submitted' => 'bg-fuchsia-100 dark:bg-fuchsia-900/30 text-fuchsia-700 dark:text-fuchsia-400',
                            'thesis.guidance_approved' => 'bg-pink-100 dark:bg-pink-900/30 text-pink-700 dark:text-pink-400',
