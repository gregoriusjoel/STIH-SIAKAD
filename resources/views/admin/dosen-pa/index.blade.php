...
<div class="mb-6 flex justify-between items-center">
    ...
    <a href="{{ route('admin.dosen-pa.create') }}" class="btn-maroon px-6 py-3 rounded-lg hover:bg-opacity-90 transition flex items-center shadow-md transform hover:scale-105">
                    ...
                    <tr class="hover:bg-blue-50 transition duration-200 cursor-pointer" 
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="flex items-center">
                                <div class="h-10 w-10 rounded-full bg-maroon flex items-center justify-center text-white font-bold mr-3">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-center text-sm font-medium" @click.stop>
                            <div class="flex items-center justify-center space-x-2">
                                ...
                                <form action="{{ route('admin.dosen-pa.destroy', $dosen->id) }}" 
                                      method="POST" 
                                      class="inline"
...
<div x-ref="detailCard" x-show="showDetail" x-transition class="mt-8 bg-white rounded-xl shadow-lg border-t-4 border-maroon overflow-hidden" style="display: none;">
    <div class="p-6 border-b border-gray-200">
        <div>
            ...
            <p class="text-sm text-gray-600 mt-1">Daftar mahasiswa bimbingan: <span class="font-semibold text-maroon" x-text="selectedDosenName"></span></p>
        </div>
    </div>
            ...
            <tbody class="divide-y divide-gray-200">
                ...
                <template x-for="(mhs, index) in mahasiswaList" :key="mhs.id">
                    <tr class="hover:bg-gray-50 transition">
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900 font-medium" x-text="index + 1"></td>
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="flex items-center">
                                <div class="h-10 w-10 rounded-full bg-blue-600 flex items-center justify-center text-white font-bold mr-3" x-text="mhs.name ? mhs.name.charAt(0).toUpperCase() : '-'"></div>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-center">
                            <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-blue-100 text-blue-800" x-text="'Semester ' + (mhs.semester || '-')"></span>
                        </td>
                    </tr>
                </template>
            </tbody>
