    ...
    <div class="w-full">
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg overflow-hidden ">
            <div class="p-4 sm:p-6 border-b border-gray-200 dark:border-gray-700 bg-maroon text-white">
                ...
                <p class="text-sm mt-1 text-white text-opacity-90">Publikasikan informasi terbaru untuk civitas akademika
                </p>
            </div>
            ...
            <form action="{{ route('admin.pengumuman.store') }}" method="POST" class="p-4 sm:p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <select name="target" id="target"
                                ...
                                required>
                                <option value="semua" {{ old('target') == 'semua' ? 'selected' : '' }}>Semua (Dosen &
                                    Mahasiswa)</option>
                                <option value="dosen" {{ old('target') == 'dosen' ? 'selected' : '' }}>Dosen</option>
                                <option value="mahasiswa" {{ old('target') == 'mahasiswa' ? 'selected' : '' }}>Mahasiswa
                                </option>
                            </select>
                            @error('target')
                        ...
                        <div>
                            ...
                            <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">Kosongkan jika ingin segera
                                dipublikasikan</p>
                            @error('published_at')
                                <p class="mt-1 text-sm text-red-600"><i
                                        class="fas fa-exclamation-circle mr-1"></i>{{ $message }}</p>
                ...
                <div
                    class="mt-6 p-4 bg-blue-50 dark:bg-blue-900/10 border border-blue-200 dark:border-blue-900/30 rounded-lg">
                ...
                <!-- Submit Button -->
                <div
                    class="flex flex-col-reverse sm:flex-row justify-end gap-3 sm:gap-4 mt-8 pt-6 border-t border-gray-200 dark:border-gray-700">
