...
@section('content')
    <div class="mb-6 flex justify-between items-center">
        <div>
            ...
            <p class="text-gray-600 text-sm mt-1">Publikasikan informasi terbaru untuk civitas akademika</p>
        </div>
        <a href="{{ route('admin.pengumuman.index') }}"
            class="bg-maroon text-white hover:bg-gray-700 px-6 py-3 rounded-lg transition flex items-center shadow-md">
        ...
        <form action="{{ route('admin.pengumuman.store') }}" method="POST" class="p-6">
            ...
            <div class="mt-8 p-4 bg-maroon/5 border border-maroon/10 rounded-lg">
                <div class="flex items-start">
                    ...
                    <div>
                        <h4 class="text-sm font-semibold text-gray-900">Petunjuk Pengisian</h4>
