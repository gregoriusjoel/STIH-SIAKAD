...
<div class="mb-6 flex flex-col items-start md:flex-row md:items-center md:justify-between gap-4">
    <div>
        ...
        <p class="text-gray-600 dark:text-gray-400 text-sm mt-1">Satu baris per dosen per mata kuliah. Klik Detail untuk melihat riwayat setiap pertemuan.</p>
    </div>
</div>

{{-- Filters --}}
<form method="GET" action="{{ route('admin.absensi_dosen.index') }}"
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        <div class="flex items-end gap-3">
            <button type="submit"
                    class="px-4 py-2 bg-maroon text-white rounded-lg text-sm font-bold hover:bg-red-900 transition-all">
                    ...
                    <tr class="hover:bg-gray-50 dark:hover:bg-gray-700 transition">
                        ...
                        <td class="px-5 py-4">
                            <div class="flex items-center gap-3">
                                <div class="h-10 w-10 rounded-full bg-maroon flex items-center justify-center text-white text-sm font-bold shrink-0">
                                ...
                                <div>
                                    ...
                                    <p class="text-xs text-gray-400 dark:text-gray-500">NIDN: {{ $row->dosen->nidn ?? '-' }}</p>
                                </div>
                            </div>
                        </td>
                        <td class="px-5 py-4">
                        ...
                        <td class="px-5 py-4 text-center">
                            <span class="inline-flex items-center justify-center w-9 h-9 bg-maroon/10 dark:bg-maroon/20 text-maroon dark:text-red-400 rounded-xl text-sm font-black">
                                {{ $row->total_pertemuan }}
                            </span>
                        </td>
                        <td class="px-5 py-4 text-center">
