    ...
    <div class="w-full">
        <div class="bg-white rounded-xl shadow-lg ">
            <div class="p-6 border-b border-gray-200 bg-maroon text-white rounded-t-xl">
                ...
                <p class="text-sm mt-1 text-white text-opacity-90">Informasi lengkap mata kuliah {{ $mataKuliah->nama_mk }}
                </p>
            </div>
            ...
            <div class="p-6">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="bg-gray-50 p-4 rounded-lg">
                        ...
                        @endphp
                        <span
                            class="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium {{ $jenisColors[$mataKuliah->jenis] ?? 'bg-gray-100 text-gray-800' }}">
