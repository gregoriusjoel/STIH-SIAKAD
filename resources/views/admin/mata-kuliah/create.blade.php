    ...
    <div class="w-full">
        <div class="bg-white rounded-xl shadow-lg  overflow-hidden">
            <div class="p-6 border-b border-gray-200 bg-maroon text-white">
                ...
                <p class="text-sm mt-1 text-white text-opacity-90">Lengkapi formulir di bawah ini untuk menambahkan mata
                    kuliah</p>
            </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <select name="jenis"
                                ...
                                <option value="wajib_nasional" {{ old('jenis') == 'wajib_nasional' ? 'selected' : '' }}>Wajib
                                    Nasional</option>
                                <option value="wajib_prodi" {{ old('jenis') == 'wajib_prodi' ? 'selected' : '' }}>Wajib Prodi
                                </option>
                                <option value="pilihan" {{ old('jenis') == 'pilihan' ? 'selected' : '' }}>Pilihan</option>
                                <option value="peminatan" {{ old('jenis') == 'peminatan' ? 'selected' : '' }}>Peminatan
                                </option>
                            </select>
                        </div>
                        ...
                        <div>
                            ...
                            <select name="semester"
                                ...
                                @for($i = 1; $i <= 8; $i++)
                                    <option value="{{ $i }}" {{ old('semester') == $i ? 'selected' : '' }}>Semester {{ $i }}
                                    </option>
                                @endfor
                            </select>
                        </div>
