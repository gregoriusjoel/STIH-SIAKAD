            ...
            <div class="flex items-start gap-4">
                ...
                <div>
                    ...
                    <p class="text-yellow-800 text-sm">
                        ...
                        Untuk dapat mengakses sistem akademik, Anda harus mengisi kuesioner kepuasan berikut terlebih
                        dahulu.
                    </p>
                </div>
            </div>
            ...
            <form action="{{ route('mahasiswa.aktivasi.store') }}" method="POST" class="p-8 space-y-8">
                ...
                <div class="bg-gray-50 rounded-lg p-4 border border-gray-200">
                    <div class="grid grid-cols-2 gap-4 text-sm">
                        ...
                        <div><span class="text-gray-600">Angkatan:</span> <span
                                class="font-semibold text-gray-800">{{ $mahasiswa->angkatan ?? '-' }}</span></div>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <textarea name="saran" rows="4"
                        ...
                        placeholder="Tuliskan saran atau masukan Anda untuk perbaikan kampus..."></textarea>
                    @error('saran')
                ...
                <div class="flex justify-center pt-4">
                    <button type="submit"
                        class="px-8 py-4 bg-maroon text-white font-bold rounded-lg hover:bg-maroon-hover transition shadow-lg hover:shadow-xl flex items-center gap-3 text-lg">
