    ...
    <div class="max-w-7xl mx-auto space-y-6">
        ...
        @else
                            ...
                            <div class="flex items-center justify-between">
                                ...
                                @if(count($jadwals) > 0)
                                    <div class="text-right text-sm opacity-90">
                                        <p>{{ substr($jadwals[0]['jam_mulai'], 0, 5) }} -
                                            {{ substr(end($jadwals)['jam_selesai'], 0, 5) }}</p>
                                    </div>
                                @endif
                            </div>
                        </div>
                                            ...
                                            <div class="flex-grow">
                                                <div class="flex items-start justify-between gap-3 mb-3">
                                                    <div>
                                                        ...
                                                        <p class="text-sm text-gray-600">{{ $jadwal['kode_mk'] }} • {{ $jadwal['sks'] }} SKS
                                                        </p>
                                                    </div>
            ...
            <div class="bg-white rounded-xl shadow-lg p-6">
                ...
                return $krs->kelasMataKuliah->mataKuliah->sks ?? 0; }) }}</p>
                    </div>
