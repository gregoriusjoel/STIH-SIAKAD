    ...
    <div class="max-w-7xl mx-auto space-y-6">
        ...
        <div class="bg-white rounded-xl shadow-lg p-6">
            <div class="flex items-center justify-between">
                <div>
                    <h2 class="text-2xl font-bold text-gray-800 mb-1">Jadwal Kelas</h2>
        ...
        @else
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                @foreach($jadwalPerHari as $hari => $jadwals)
                    <div class="bg-white rounded-xl shadow-lg overflow-hidden h-full border border-gray-100 flex flex-col">
                        {{-- Day Header --}}
                        ...
                        @if(count($jadwals) > 0)
                            <div class="p-4 space-y-3 bg-gray-50 flex-grow max-h-[400px] overflow-y-auto scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-gray-100">
                                @foreach($jadwals as $jadwal)
                                    <div class="bg-white border border-gray-200 rounded-lg p-4 shadow-sm hover:shadow-md transition-all hover:border-maroon group">
                                        {{-- Time Badge --}}
                                        ...
                                        <div class="pt-2 border-t border-gray-100 flex justify-between items-center">
                                            <span class="text-[10px] text-gray-400 font-medium uppercase tracking-wider">Kelas</span>
