...
@section('title', 'Upload Bukti Bayar Penuh')
            ...
            <div class="relative z-10 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                <div>
                    ...
                    <div class="flex items-baseline gap-2">
                        <span class="text-2xl font-bold">Bayar Penuh</span>
                ...
                <div class="text-left sm:text-right">
                    <h2 class="text-white/80 text-sm font-medium uppercase tracking-wider mb-1">Sisa Tagihan</h2>
                    <p class="text-3xl font-bold">Rp {{ number_format($dueAmount, 0, ',', '.') }}</p>
                </div>
            </div>
        </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="relative">
                                ...
                                <input type="hidden" name="amount_submitted" id="amount_submitted_raw" value="{{ old('amount_submitted', $dueAmount) }}">
                                <input type="text" id="amount_submitted_display"
                                       ...
                                       value="{{ number_format(old('amount_submitted', $dueAmount), 0, ',', '.') }}"
                                       inputmode="numeric"
                                       required>
                            </div>
                            @error('amount_submitted')
                                <p class="text-xs text-red-500 mt-1">{{ $message }}</p>
                            @enderror
                            <p class="text-[10px] text-slate-500 italic">* Nominal harus sama dengan sisa tagihan (bayar penuh)</p>
                        </div>
                    </div>
        ...
        <div class="bg-blue-50 border border-blue-100 rounded-2xl p-6 flex gap-4">
            ...
            <div>
                ...
                <ul class="text-xs text-blue-700/80 space-y-1.5 list-disc list-inside">
                    <li>Pastikan nominal transfer sama dengan sisa tagihan.</li>
                    ...
                    <li>Status tagihan akan berubah menjadi <strong>LUNAS</strong> setelah disetujui.</li>
                </ul>
            </div>
        </div>
    </div>
