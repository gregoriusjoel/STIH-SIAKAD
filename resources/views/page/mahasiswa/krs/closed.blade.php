                        ...
                        <div class="p-8 text-center relative z-10">
                            ...
                            <div class="space-y-3 mb-8">
                                ...
                                <p class="text-gray-500 dark:text-gray-400 text-[13px] leading-relaxed max-w-[260px] mx-auto font-medium">
                                    {{ $message ?? 'Akses pengisian Kartu Rencana Studi (KRS) saat ini tidak tersedia atau sudah melewati batas waktu.' }}
                                </p>
                            </div>
                                ...
                                <div class="flex items-center gap-3 mb-4 pb-4 border-b border-gray-100 dark:border-white/10">
                                    ...
                                    <div>
                                        ...
                                        <h4 class="font-extrabold text-gray-900 dark:text-white text-sm">
                                            {{ $semesterAktif->nama_semester ?? '-' }} {{ $semesterAktif->tahun_ajaran ?? '' }}
                                        </h4>
                                    </div>
                                </div>
                                ...
                                <div class="space-y-3">
                                    ...
                                    <div class="flex items-center justify-between p-2.5 rounded-lg bg-white dark:bg-black/20 border border-gray-50 dark:border-white/5 shadow-sm">
                                        ...
                                        <span class="text-xs font-black text-gray-900 dark:text-white">
                                            {{ $krsMultai ? \Carbon\Carbon::parse($krsMultai)->translatedFormat('d M Y') : '-' }}
                                        </span>
                                    </div>
                                    ...
                                    <div class="flex items-center justify-between p-2.5 rounded-lg bg-white dark:bg-black/20 border border-gray-50 dark:border-white/5 shadow-sm">
                                        ...
                                        <span class="text-xs font-black text-gray-900 dark:text-white">
                                            {{ $krsSelesai ? \Carbon\Carbon::parse($krsSelesai)->translatedFormat('d M Y') : '-' }}
                                        </span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="space-y-5">
                                ...
                                <a href="{{ route('mahasiswa.dashboard') }}" class="group relative flex items-center justify-center w-full px-6 py-3.5 bg-[#1a1c23] dark:bg-white text-white dark:text-[#1a1c23] rounded-xl font-black text-xs tracking-wide transition-all duration-300 hover:shadow-[0_15px_40px_rgba(0,0,0,0.15)] dark:hover:shadow-[0_15px_40px_rgba(255,255,255,0.05)] overflow-hidden">
                    ...
                    <div class="hidden md:block overflow-x-auto">
                        <table class="w-full">
                            ...
                            <tbody class="divide-y divide-gray-50 dark:divide-white/5">
                                @forelse(isset($semesterList) ? $semesterList : collect() as $sem)
                                    @php
                                        ...
                                        <td class="px-6 py-4">
                                            <div class="flex items-center gap-3">
                                                <div class="w-8 h-8 rounded-lg bg-gray-100 dark:bg-white/5 flex items-center justify-center text-gray-500 dark:text-gray-400 group-hover:bg-[#8B1538] group-hover:text-white transition-all duration-300 shadow-sm">
                                                    <span class="text-xs font-black">{{ $sem->semester_number ?? 1 }}</span>
                                                </div>
                                                <span class="text-xs font-bold text-gray-900 dark:text-white">Semester {{ $sem->semester_number ?? 1 }}</span>
                                            </div>
                                        </td>
                                        <td class="px-6 py-4">
                            ...
                            <div class="p-6 space-y-5">
                                <div class="flex justify-between items-center">
                                    <div class="flex items-center gap-3">
                                        ...
                                        <div>
                                            <h4 class="text-sm font-black text-gray-900 dark:text-white">Semester {{ $sem->semester_number ?? 1 }}</h4>
                                            <p class="text-[10px] font-bold text-gray-400 uppercase tracking-widest mt-0.5">TA {{ $sem->tahun_ajaran ?? '-' }}</p>
                                        </div>
                                    </div>
