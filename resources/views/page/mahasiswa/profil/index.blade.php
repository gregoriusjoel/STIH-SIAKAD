            ...
            <div class="space-y-6">
                <div class="bg-white dark:bg-[#1a1d2e] rounded-xl shadow-lg p-6 text-center h-full">
                        <div class="relative w-40 h-40 mx-auto mb-6 group">
                            <div class="w-40 h-40 rounded-full overflow-hidden border-4 border-gray-100 dark:border-slate-700 shadow-sm relative flex items-center justify-center bg-gray-100 dark:bg-slate-700">
                    ...
                    <form action="{{ route('mahasiswa.profil.update-foto') }}" method="POST" enctype="multipart/form-data"
                        ...
                        <div x-data="photoCropper()" class="mb-4">
