...
<div class="space-y-4">
            ...
            <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div class="flex items-center gap-5">
                    ...
                    <div>
                        ...
                        <h1 class="text-2xl font-black text-gray-900 tracking-tight">Pengajuan Skripsi</h1>
                        <p class="text-sm text-gray-500 mt-1">Lengkapi informasi berikut untuk memulai pengajuan skripsi Anda.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="bg-red-50 border border-red-100 rounded-2xl p-4 flex items-start gap-3">
        ...
        <div class="flex-1">
            <h3 class="font-bold text-red-900 text-sm">Skripsi Perlu Perbaikan</h3>
    ...
    <div class="flex flex-col lg:flex-row gap-6">
        ...
        <div class="w-full lg:w-[32%] space-y-4 shrink-0">
            ...
            <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
                ...
                <ul class="space-y-4">
                    @foreach([
                        ...
                        ['t' => 'Berkas PDF/DOC', 'b' => 'Unggah berkas skripsi dalam format yang ditentukan (Maks 10MB).', 'i' => 'description'],
                    ] as $item)
                    <li class="flex gap-3">
                ...
                <div class="mt-6 pt-5 border-t border-gray-50">
                    <div class="flex items-center gap-2 bg-blue-50 border border-blue-100 rounded-xl px-3 py-2.5">
                        ...
                        <p class="text-[11px] text-blue-700 leading-tight font-medium">Skripsi Anda akan diverifikasi oleh Admin/Prodi sebelum dilanjutkan.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-[#8B1538]/5 rounded-2xl border border-[#8B1538]/10 p-5">
                ...
                <div class="space-y-3">
                    @foreach(['Sudah Verifikasi SKS', 'Draft Skripsi Lengkap', 'Persetujuan Calon Pembimbing'] as $check)
        ...
        <div class="flex-1 min-w-0">
            <div class="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
                <div class="px-6 py-5 border-b border-gray-50 flex items-center gap-3">
                    ...
                    <h2 class="font-bold text-gray-800 text-sm">Formulir Skripsi</h2>
                </div>
                ...
                <form action="{{ route('mahasiswa.skripsi.proposal.submit') }}" method="POST" enctype="multipart/form-data" class="p-6 space-y-6">
                    ...
                    {{-- Deskripsi --}}
                    <div>
                        <label class="block text-xs font-bold text-gray-500 uppercase tracking-widest mb-2 px-1">Ringkasan Skripsi</label>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        {{-- File --}}
                        <div>
                            <label class="block text-xs font-bold text-gray-500 uppercase tracking-widest mb-2 px-1">Berkas Skripsi</label>
