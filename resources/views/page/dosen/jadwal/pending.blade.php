...
<div class="flex flex-col min-w-0 h-full">
    <div class="p-6 md:p-8 max-w-[900px] mx-auto w-full flex flex-col gap-6">
        
        <!-- Header -->
        <div class="text-center mb-4">
            <div class="size-16 rounded-full bg-gradient-to-br from-amber-400 to-amber-600 flex items-center justify-center text-white mx-auto mb-4 animate-pulse-slow">
