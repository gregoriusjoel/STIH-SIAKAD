...
@section('content')
    <div class="px-2 sm:px-4 py-4 sm:py-6 max-w-[1600px] mx-auto font-inter" x-data="{ 
        ...
        <form method="POST" action="{{ route('dosen.prestasi.store') }}" enctype="multipart/form-data">
            @csrf
            <input type="hidden" name="tipe" value="{{ $tipe }}">

            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 items-stretch">

                {{-- Column 1: Informasi Kegiatan --}}
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-5 sm:gap-6">
                            <div class="sm:col-span-2">
                                ...
                                <input type="text" name="nama_kegiatan" value="{{ old('nama_kegiatan') }}" required
                                    placeholder="Contoh: Konferensi Internasional 2026"
                        ...
                        <div class="space-y-5">
                            <div>
                                ...
                                <input type="text" name="jenis_prestasi" value="{{ old('jenis_prestasi') }}"
                                    :required="tipe === 'pelaporan'" placeholder="Contoh: Pembicara Utama / Peserta"
                                    class="w-full rounded-xl border-0 bg-slate-50 text-sm px-4 py-3 focus:ring-2 focus:ring-[#7a1621]/20 focus:bg-white transition">
                            </div>
            ...
            <div
                ...
                <div class="flex flex-col sm:flex-row items-center gap-3 w-full sm:w-auto">
                    <a href="{{ route('dosen.prestasi.index') }}"
                        class="w-full sm:w-auto px-8 py-3 text-sm font-bold text-gray-500 hover:bg-gray-100 rounded-xl transition-colors text-center order-2 sm:order-1">Batal</a>
                    <button type="submit"
