    ...
    <div
        ...
        <div class="p-8">
            <div class="w-20 h-20 bg-red-50 rounded-full flex items-center justify-center mx-auto mb-6">
                <i class="fas fa-exclamation-triangle text-4xl text-maroon"></i>
            </div>

            <h1 class="text-3xl font-bold text-gray-800 mb-2">Terjadi Kesalahan</h1>
            <h2 class="text-xl font-semibold text-gray-600 mb-4">500 - Server Error</h2>

            <p class="text-gray-500 mb-8">
                Mohon maaf, terjadi kesalahan pada server internal kami.
