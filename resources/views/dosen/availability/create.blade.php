...
@section('content')
    <div class="space-y-6">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg  overflow-hidden">
            <div
                class="px-6 py-5 border-b border-gray-200 dark:border-gray-700 bg-maroon text-white flex items-center justify-between">
                <div class="font-bold text-white text-xl flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <div class="text-sm font-normal text-white/80 mt-1">{{ $activeSemester->nama_semester }}
                            {{ $activeSemester->tahun_ajaran }}</div>
                    </div>
                </div>
            ...
            <div class="px-6 py-5 bg-blue-50 dark:bg-gray-700/50">
                <div
                    class="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-900/30 text-blue-700 dark:text-blue-300 px-5 py-4 rounded-xl text-sm flex gap-4 items-start">
                    ...
                    <div>
                        ...
                        <ul class="space-y-1 text-sm">
                            <li><i class="fas fa-mouse-pointer text-blue-500 mr-2"></i><strong>Klik</strong> pada kotak
                                waktu untuk memilih/membatalkan</li>
                            <li><i class="fas fa-hand-pointer text-blue-500 mr-2"></i><strong>Drag (Seret)</strong> untuk
                                memilih banyak slot sekaligus</li>
                            <li><i class="fas fa-square text-green-500 mr-2"></i>Hijau = Tersedia | <i
                                    class="fas fa-square text-blue-500 mr-2"></i>Biru = Terjadwal (terkunci)</li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg overflow-hidden">
                <div class="px-6 py-5 border-b border-gray-200 dark:border-gray-700 flex items-center justify-between">
                    ...
                    <div class="flex items-center gap-4">
                        <div
                            class="selection-counter px-4 py-2 bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg">
                    ...
                    <table class="w-full border-collapse" id="availabilityTable">
                        <thead>
                            <tr class="bg-maroon text-white text-xs">
                                <th
                                    class="px-3 py-2 text-left font-semibold border border-gray-300 dark:border-gray-600 sticky left-0 bg-maroon z-20 rounded-tl-lg">
                                    <div class="text-sm">Jam</div>
                                </th>
                                @foreach($days as $day)
                                    <th
                                        class="px-2 py-2 text-center font-semibold border border-gray-300 dark:border-gray-600 min-w-[100px] {{ $loop->last ? 'rounded-tr-lg' : '' }}">
                        ...
                        <tbody>
                            @foreach($jamPerkuliahan as $jam)
                                <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/30 transition text-xs">
                                    <td
                                        class="px-3 py-2 border border-gray-300 dark:border-gray-600 font-medium text-gray-700 dark:text-gray-300 sticky left-0 bg-white dark:bg-gray-800 z-10 w-28">
                                        <div class="font-bold text-sm">Jam {{ $jam->jam_ke }}</div>
                                        <div class="text-[11px] text-gray-500 dark:text-gray-400 leading-tight">
                                    ...
                                    @foreach($days as $day)
                                        ...
                                        <td class="px-1.5 py-1.5 border border-gray-300 dark:border-gray-600">
                                            <label class="block relative w-full h-full m-0">
                                                <input type="checkbox" name="slots[]" value="{{ $day }}_{{ $jam->id }}"
                                                    class="slot-checkbox" data-day="{{ $day }}" data-jam="{{ $jam->id }}" {{ $isChecked ? 'checked' : '' }} {{ $isBooked ? 'disabled' : '' }}>
                ...
                <div class="px-6 py-5 bg-gray-50 dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700">
                    <div class="flex flex-col md:flex-row items-center justify-between gap-4">
                        <div class="flex items-center gap-6 text-sm">
                            ...
                            <div class="flex items-center gap-2">
                                <div
                                    class="w-6 h-6 bg-gray-200 dark:bg-gray-600 rounded-lg border-2 border-gray-400 dark:border-gray-500">
                                </div>
