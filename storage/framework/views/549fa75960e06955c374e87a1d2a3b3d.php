                            ...
                            <tr class="group hover:bg-[#8B1538]/[0.02] transition-colors">
                                <td class="px-8 py-6">
                                    <div class="flex items-center gap-4">
                                        <div class="size-12 rounded-2xl bg-slate-100 border border-slate-200 overflow-hidden shrink-0 group-hover:scale-110 transition-transform">
                                            <img src="https://ui-avatars.com/api/?name=<?php echo e(urlencode($proof->invoice->student->user->name ?? 'User')); ?>&background=8B1538&color=fff&bold=true" alt="Avatar">
                                        </div>
                                        <div>
                                            <p class="text-sm font-black text-slate-700 leading-tight"><?php echo e($proof->invoice->student->user->name ?? 'N/A'); ?></p>
                                            <p class="text-[10px] font-black uppercase tracking-widest text-slate-400 mt-1"><?php echo e($proof->invoice->student->nim ?? 'N/A'); ?></p>
                                        </div>
                                    </div>
                                </td>
                                <td class="px-8 py-6">
                                    <div class="flex flex-col">
                                        <span class="text-sm font-black text-[#8B1538] tracking-tight">Rp <?php echo e(number_format($proof->amount_submitted, 0, ',', '.')); ?></span>
                                        <span class="text-[10px] font-black uppercase text-slate-400 tracking-widest mt-1">
                                            VIA <?php echo e($proof->method ?? 'N/A'); ?>
                                ...
                                <td class="px-8 py-6 text-center">
                                    <div class="inline-flex flex-col items-center px-4 py-2 bg-slate-50 rounded-2xl border border-slate-100 shadow-sm">
                                        <span class="text-sm font-black text-slate-700"><?php echo e($proof->transfer_date->format('d M')); ?></span>
                                        <span class="text-[8px] font-black uppercase tracking-tighter text-slate-400 leading-none mt-0.5"><?php echo e($proof->transfer_date->format('Y')); ?></span>
                                    </div>
                                </td>
                                <td class="px-8 py-6 text-right">
                                    <a href="<?php echo e(route('finance.payment-proofs.show', $proof)); ?>" 
...
<?php echo $__env->make('layouts.finance', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/naradata/STIH-SIAKAD/resources/views/finance/payment-proofs/index.blade.php ENDPATH**/ ?>