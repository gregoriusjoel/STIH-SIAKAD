<?php $__env->startSection('title', 'Skripsi - Progress'); ?>
<?php $__env->startSection('page-title', 'Skripsi'); ?>
...
<div class="px-4 py-4 max-w-[1600px] mx-auto space-y-3">
        ...
        <div class="relative z-10 flex flex-wrap items-center gap-2">
            <div class="flex items-center gap-2 px-3 py-2 bg-gray-50 border border-gray-200 rounded-xl">
                ...
                <div>
                    ...
                    <p class="text-sm font-black text-gray-800 leading-tight"><?php echo e($sksEligible ? $currentStep : 0); ?> / 7</p>
                </div>
            </div>
            <div class="flex items-center gap-2 px-3 py-2 bg-gray-50 border border-gray-200 rounded-xl">
                ...
                <div>
                    ...
                    <p class="text-sm font-black <?php echo e($sksEligible ? 'text-emerald-700' : 'text-red-700'); ?> leading-tight"><?php echo e($summary['total_sks']); ?>/<?php echo e($summary['min_sks']); ?></p>
                </div>
            </div>
            <div class="flex items-center gap-2 px-3 py-2 bg-gray-50 border border-gray-200 rounded-xl">
                <span class="material-symbols-outlined text-[16px] <?php echo e(($summary['has_logbook'] ?? false) ? 'text-emerald-500' : 'text-amber-500'); ?>">menu_book</span>
                <div>
                    <p class="text-[9px] font-bold text-gray-400 uppercase tracking-wider leading-none">Logbook</p>
                    <?php if($summary['has_logbook'] ?? false): ?>
            ...
            <?php if($sksEligible && $submission): ?>
            <span class="px-3 py-2 rounded-xl text-xs font-bold bg-<?php echo e($color); ?>-50 border border-<?php echo e($color); ?>-200 text-<?php echo e($color); ?>-700">
    ...
    <div class="bg-red-50/80 border border-red-200/60 rounded-2xl p-4 flex items-start gap-3">
        ...
        <div>
            ...
            <p class="text-sm text-red-600 font-medium mt-0.5">
                Anda memiliki <strong><?php echo e($summary['total_sks']); ?> SKS</strong> dari minimal
                <strong><?php echo e($summary['min_sks']); ?> SKS</strong>. Masih kurang
                <strong><?php echo e($summary['sks_shortage']); ?> SKS</strong>.
            </p>
        </div>
    </div>
    ...
    <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
        ...
        <ol class="grid grid-cols-1 sm:grid-cols-2 gap-2">
            <?php $__currentLoopData = [
                ...
                'Revisi',
                'Skripsi Selesai',
            ]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <li class="flex items-center gap-3 px-4 py-2.5 rounded-xl <?php echo e($i === 0 ? 'bg-red-50 border border-red-100' : 'bg-gray-50'); ?>">
                <div class="w-7 h-7 rounded-full flex items-center justify-center shrink-0 text-xs font-bold
                    <?php echo e($i === 0 ? 'bg-[#8B1538] text-white' : 'bg-gray-200 text-gray-400'); ?>"><?php echo e($i + 1); ?></div>
                <span class="text-sm font-medium <?php echo e($i === 0 ? 'text-red-800' : 'text-gray-400'); ?>"><?php echo e($label); ?></span>
                <?php if($i !== 0): ?>
    ...
    <?php if($submission && in_array($submission->status->value, ['PROPOSAL_SUBMITTED','SIDANG_REG_SUBMITTED','REVISION_UPLOADED'])): ?>
    <?php
    ...
    <div class="bg-amber-50/80 border border-amber-200/60 rounded-2xl p-4 flex items-start gap-3">
        ...
        <div>
            ...
            <p class="text-sm text-amber-600 font-medium mt-0.5"><?php echo e($alertMsg); ?></p>
        </div>
    </div>
    <?php endif; ?>

    <?php if($submission && $submission->status->value === 'THESIS_COMPLETED'): ?>
    <div class="rounded-2xl p-4 flex items-center gap-4 border border-emerald-200" style="background:linear-gradient(135deg,#ecfdf5,#d1fae5)">
        ...
        <div>
            ...
            <p class="text-xs text-emerald-600 mt-0.5">Revisi disetujui pada <?php echo e($submission->revision_approved_at?->format('d F Y')); ?></p>
        </div>
    </div>
    <?php endif; ?>
    ...
    <div class="flex flex-col lg:flex-row gap-3 items-start">
        ...
        <div class="w-full lg:w-[30%] shrink-0">
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden sticky top-4">
                <div class="px-4 py-3 border-b border-gray-50 flex items-center justify-between">
                    ...
                    <span class="text-xs font-bold text-[#8B1538]"><?php echo e($currentStep); ?>/7</span>
                </div>
                <div class="px-4 py-2 bg-gray-50 border-b border-gray-100">
                    ...
                    <div class="flex justify-between text-[11px] mb-1">
                        ...
                        <span class="font-bold <?php echo e($textColor); ?>"><?php echo e(round(($currentStep/7)*100)); ?>%</span>
                    </div>
                    <div class="bg-gray-200 rounded-full h-1.5 overflow-hidden">
                        <div class="rounded-full h-full transition-all"
                            style="width:<?php echo e(round(($currentStep/7)*100)); ?>%; background:<?php echo e($barColor); ?>"></div>
                    </div>
                </div>
                <ol class="px-2 py-2 flex flex-col gap-1">
                    <?php $__currentLoopData = $steps; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $step => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php 
                    ...
                    <li class="flex items-center gap-3 px-3 py-3 rounded-xl transition-colors
                        <?php echo e($active ? ($isErrorState ? 'bg-orange-50 border border-orange-200' : 'bg-red-50 border border-red-100') : ($done ? 'hover:bg-gray-50' : '')); ?>">
                        <div class="w-8 h-8 rounded-full border-2 flex items-center justify-center shrink-0 text-xs font-black
                            <?php echo e($done ? 'bg-[#8B1538] border-[#8B1538] text-white' :
                        ...
                        <div class="flex-1 min-w-0">
                            <span class="text-sm font-semibold block truncate
                                <?php echo e($active ? ($isErrorState ? 'text-orange-700' : 'text-[#8B1538]') : ($done ? 'text-gray-600' : 'text-gray-300')); ?>">
                                <?php echo e($label); ?>
                        ...
                        <?php if($active): ?>
                            <div class="w-2 h-2 rounded-full shrink-0 <?php echo e($isErrorState ? 'bg-orange-500 animate-pulse' : 'bg-[#8B1538]'); ?>"></div>
                        <?php endif; ?>
                    </li>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </ol>
        ...
        <div class="flex-1 min-w-0 space-y-3">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                ...
                <?php if(!$submission || in_array($submission?->status->value, ['PROPOSAL_DRAFT','PROPOSAL_REJECTED'])): ?>
                <?php $rejected = $submission?->status->value === 'PROPOSAL_REJECTED'; ?>
                <a href="<?php echo e(route('mahasiswa.skripsi.proposal')); ?>"
                    ...
                    <div class="flex items-start gap-4 relative z-10">
                        <div class="w-13 h-13 rounded-xl <?php echo e($rejected ? 'bg-red-100' : 'bg-gradient-to-br from-[#8B1538] to-[#6D1029]'); ?> text-white flex items-center justify-center shadow-sm shrink-0" style="width:52px;height:52px">
                            <span class="material-symbols-outlined text-2xl <?php echo e($rejected ? 'text-red-600' : ''); ?>">description</span>
                        </div>
                        <div class="flex-1 min-w-0">
                            <div class="flex items-center gap-2 mb-1.5 flex-wrap">
                                <h3 class="font-bold text-gray-900 group-hover:text-[#8B1538] transition-colors">
                                    <?php echo e($rejected ? 'Revisi Skripsi' : 'Ajukan Skripsi'); ?>
                            ...
                            <p class="text-sm text-gray-500 leading-relaxed">
                                <?php echo e($rejected ? ($submission->admin_note ?? 'Perbaiki dan kirim ulang skripsi') : 'Pilih judul penelitian & dosen pembimbing Anda untuk memulai proses skripsi.'); ?>
                    ...
                    <div class="mt-5 pt-4 border-t border-gray-50 flex items-center justify-between">
                        <span class="text-xs font-bold text-[#8B1538] flex items-center gap-1 group-hover:gap-2 transition-all">
                            <?php echo e($rejected ? 'Perbaiki Sekarang' : 'Mulai Sekarang'); ?>
                ...
                <?php if($submission && in_array($submission->status->value, ['BIMBINGAN_ACTIVE','ELIGIBLE_SIDANG','SIDANG_REG_DRAFT','SIDANG_REG_REJECTED'])): ?>
                <?php $hasLogbook = !empty($submission->logbook_file_path); ?>
                <a href="<?php echo e(route('mahasiswa.skripsi.bimbingan')); ?>"
                    ...
                    <div class="flex items-start gap-3 relative z-10">
                        ...
                        <div class="flex-1 min-w-0">
                            ...
                            <div class="flex items-center gap-1.5">
                                ...
                                <p class="text-xs text-emerald-600 font-medium truncate"><?php echo e($submission->logbook_original_name); ?></p>
                            </div>
                            <p class="text-[10px] text-gray-400 mt-0.5">Upload: <?php echo e($submission->logbook_uploaded_at?->format('d M Y')); ?></p>
                            <?php else: ?>
                    ...
                    <div class="mt-4 pt-3.5 border-t border-gray-50 flex items-center justify-between">
                        <span class="text-xs font-bold text-blue-700 flex items-center gap-1 group-hover:gap-2 transition-all">
                            <?php echo e($hasLogbook ? 'Lihat Detail' : 'Upload Sekarang'); ?> <span class="material-symbols-outlined text-[15px]">arrow_forward</span>
                        </span>
                ...
                <?php if($submission && in_array($submission->status->value, ['ELIGIBLE_SIDANG','SIDANG_REG_DRAFT','SIDANG_REG_REJECTED'])): ?>
                <?php $regRej = $submission->status->value === 'SIDANG_REG_REJECTED'; ?>
                <a href="<?php echo e(route('mahasiswa.skripsi.sidang.registration')); ?>"
                    ...
                    <div class="flex items-start gap-3 relative z-10">
                        <div class="w-11 h-11 rounded-xl <?php echo e($regRej ? 'bg-orange-100' : 'bg-gradient-to-br from-teal-500 to-teal-700'); ?> text-white flex items-center justify-center shadow-sm shrink-0">
                            <span class="material-symbols-outlined text-xl <?php echo e($regRej ? 'text-orange-600' : ''); ?>">assignment</span>
                        </div>
                        <div class="flex-1 min-w-0">
                            ...
                            <p class="text-xs text-gray-500"><?php echo e($regRej ? 'Lengkapi dan kirim ulang berkas' : 'Upload berkas persyaratan sidang'); ?></p>
                        </div>
                    </div>
                    <div class="mt-4 pt-3.5 border-t border-gray-50 flex items-center justify-between">
                        <span class="text-xs font-bold text-teal-700 flex items-center gap-1 group-hover:gap-2 transition-all">
                            <?php echo e($regRej ? 'Perbaiki Berkas' : 'Daftar Sekarang'); ?>
                ...
                <?php if($submission && $submission->status->value === 'REVISION_PENDING'): ?>
                <div class="bg-white rounded-2xl p-5 shadow-sm border border-orange-100 md:col-span-2">
                    ...
                    <form action="<?php echo e(route('mahasiswa.skripsi.revision.upload')); ?>" method="POST" enctype="multipart/form-data" class="flex flex-col sm:flex-row gap-3">
                        <?php echo csrf_field(); ?>
                ...
                <?php if($submission?->sidangSchedule): ?>
                <?php $sch = $submission->sidangSchedule; ?>
                <div class="bg-white rounded-2xl p-5 shadow-sm border border-indigo-100 flex flex-col justify-between">
                    <div class="flex items-center gap-3 mb-4">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-indigo-500 mt-0.5 font-medium"><?php echo e($sch->tanggal->format('d F Y')); ?></p>
                        </div>
                    </div>
                    <dl class="grid grid-cols-1 sm:grid-cols-2 gap-2 mt-auto">
                        ...
                        <div class="bg-gray-50 border border-gray-100 rounded-xl px-3 py-2.5">
                            <div class="flex items-center gap-1 mb-1">
                                <span class="material-symbols-outlined text-[13px] <?php echo e($item['color']); ?>"><?php echo e($item['icon']); ?></span>
                                <dt class="text-[9px] font-bold text-gray-400 uppercase tracking-wider"><?php echo e($item['label']); ?></dt>
                            </div>
                            <dd class="text-xs font-semibold text-gray-800 truncate"><?php echo e($item['value']); ?></dd>
                        </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </dl>
                </div>
                ...
                <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 flex flex-col justify-between">
                    <div class="flex items-start gap-4">
                        <div class="w-[52px] h-[52px] rounded-xl <?php echo e($guide['bg']); ?> flex items-center justify-center shrink-0">
                            <span class="material-symbols-outlined text-2xl <?php echo e($guide['color']); ?>"><?php echo e($guide['icon']); ?></span>
                        </div>
                        <div class="flex-1 min-w-0">
                            <h3 class="font-bold text-gray-800 mb-1.5 flex items-center"><?php echo $guide['title']; ?></h3>
                            <p class="text-sm text-gray-500 leading-relaxed"><?php echo e($guide['body']); ?></p>
                        </div>
                    </div>
                    <div class="mt-5 flex items-start gap-2 bg-amber-50 border border-amber-100 rounded-xl px-3 py-3">
                        ...
                        <p class="text-sm text-amber-700 font-medium leading-relaxed"><?php echo e($guide['tip']); ?></p>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.mahasiswa', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/naradata/STIH-SIAKAD/resources/views/page/mahasiswa/skripsi/index.blade.php ENDPATH**/ ?>