<?php $__env->startSection('title', 'Akademik - Nilai'); ?>
<?php $__env->startSection('page-title', 'Nilai Akademik'); ?>
    ...
    <div class="space-y-6">
        ...
        <div class="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-3 md:gap-6">
            ...
            <div class="bg-white dark:bg-slate-800 rounded-3xl p-4 md:p-6 shadow-sm border border-blue-100 dark:border-blue-900/30 group hover:shadow-xl hover:shadow-blue-500/5 transition-all duration-300">
                ...
                <h3 class="text-2xl md:text-4xl font-black text-slate-900 dark:text-white mb-1"><?php echo e(number_format($ipk, 2)); ?></h3>
            ...
            <div class="bg-white dark:bg-slate-800 rounded-3xl p-4 md:p-6 shadow-sm border border-green-100 dark:border-green-900/30 group hover:shadow-xl hover:shadow-green-500/5 transition-all duration-300">
                ...
                <h3 class="text-2xl md:text-4xl font-black text-slate-900 dark:text-white mb-1"><?php echo e($totalSks); ?></h3>
            ...
            <div class="bg-white dark:bg-slate-800 rounded-3xl p-4 md:p-6 shadow-sm border border-amber-100 dark:border-amber-900/30 group hover:shadow-xl hover:shadow-amber-500/5 transition-all duration-300">
                ...
                <h3 class="text-2xl md:text-4xl font-black text-slate-900 dark:text-white mb-1"><?php echo e(number_format($latestIps, 2)); ?></h3>
            ...
            <div class="bg-white dark:bg-slate-800 rounded-3xl p-4 md:p-6 shadow-sm border border-purple-100 dark:border-purple-900/30 group hover:shadow-xl hover:shadow-purple-500/5 transition-all duration-300">
                ...
                <h3 class="text-2xl md:text-4xl font-black text-slate-900 dark:text-white mb-1">
                    <?php echo e($nilaiPerSemester->sum(function ($items) {
                        return $items->count(); })); ?>
        ...
        <div id="rangkuman">
            <?php echo $__env->make('page.mahasiswa.nilai._content', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        </div>

        <div id="khs" class="hidden">
            <?php echo $__env->make('page.mahasiswa.khs._content', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        </div>
    </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.mahasiswa', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/naradata/STIH-SIAKAD/resources/views/page/mahasiswa/nilai/index.blade.php ENDPATH**/ ?>