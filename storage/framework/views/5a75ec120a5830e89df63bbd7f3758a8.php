...
<head>
    ...
    <link rel="shortcut icon" type="image/png" href="<?php echo e(asset('images/logo_stih_white.png')); ?>">
    ...
    <style>
        body {
            background: url('<?php echo e(asset('images/bg.png')); ?>') no-repeat center center fixed;
...
<body class="flex items-center justify-center min-h-screen p-4">
    ...
    <div class="w-full max-w-md">
        <div class="login-card rounded-2xl shadow-xl p-10">
                    ...
                    <div class="logo-container relative cursor-pointer">
                        ...
                        <div class="relative bg-white rounded-2xl p-1 shadow-lg">
                            ...
                            <div class="logo-box w-20 h-20 bg-maroon rounded-xl flex items-center justify-center shadow-inner relative overflow-hidden">
                                ...
                                <img src="<?php echo e(asset('images/logo_stih_white.png')); ?>" alt="STIH Logo" class="w-12 h-12 relative z-10 drop-shadow-lg">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <?php if(session('error')): ?>
                <div class="mb-6 p-4 rounded-lg bg-red-50 border border-red-100">
                    <div class="flex items-start">
                        ...
                        <span class="text-red-700 text-sm"><?php echo e(session('error')); ?></span>
                    </div>
                </div>
            <?php endif; ?>
            ...
            <?php if(session('success')): ?>
                <div class="mb-6 relative overflow-hidden bg-[#F4FBF6] rounded-xl border border-[#EBEBEB] shadow-sm flex items-center">
                    <div class="py-3 px-5 flex items-center">
                        ...
                        <div>
                            <span class="text-[#065F46] font-medium text-sm"><?php echo e(session('success')); ?></span>
                        </div>
                    </div>
                </div>
            <?php endif; ?>
            ...
            <!-- Login Form -->
            <form action="<?php echo e(route('login.post')); ?>" method="POST" autocomplete="on">
                <?php echo csrf_field(); ?>
                ...
                <div class="mb-5">
                    ...
                    <div class="input-group">
                        <input 
                            ...
                            class="w-full px-4 py-3.5 pl-12 border border-gray-300 rounded-lg focus:outline-none focus:border-maroon bg-gray-50 <?php $__errorArgs = ['email'];
...
$message = $__bag->first($__errorArgs[0]); ?>
                        <p class="text-red-500 text-xs mt-1.5 flex items-center">
                            <i class="fas fa-info-circle mr-1"></i><?php echo e($message); ?>
                ...
                <div class="mb-5">
                    ...
                    <div class="input-group">
                        <input 
                            ...
                            id="password" 
                            name="password" 
                            class="w-full px-4 py-3.5 pl-12 pr-12 border border-gray-300 rounded-lg focus:outline-none focus:border-maroon bg-gray-50 <?php $__errorArgs = ['password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 bg-red-50 <?php unset($message);
...
<?php /**PATH /Users/naradata/STIH-SIAKAD/resources/views/auth/login.blade.php ENDPATH**/ ?>