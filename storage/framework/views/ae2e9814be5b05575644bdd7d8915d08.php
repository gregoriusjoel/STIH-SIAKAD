...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'SIAKAD STIH'); ?> - Admin Panel</title>
    <!-- Favicon -->
...
<body class="bg-gray-100 overflow-hidden">
    ...
    <div class="flex h-screen overflow-hidden relative">
        <!-- Sidebar -->
        <?php echo $__env->make('admin.sidebar-admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        ...
        <div class="flex-1 flex flex-col overflow-hidden w-full">
                ...
                <div class="admin-topbar-row flex items-center justify-between px-6">
                    <div class="flex items-center gap-4 min-h-11">
                        ...
                        <nav class="text-sm breadcrumb flex items-center leading-none">
                            ...
                            <span class="font-semibold"><?php echo $__env->yieldContent('page-title', 'Dashboard'); ?></span>
                        </nav>
                        <div class="ml-4 flex items-center">
                            ...
                            <?php if($activeSemester): ?>
                                <span
                                    class="inline-block px-3 py-1 rounded-full text-xs font-medium text-white top-badge"><?php echo e($activeSemester->nama_semester); ?>

                                    <?php echo e($activeSemester->tahun_ajaran); ?></span>
                            <?php else: ?>
                                <span
                    ...
                    <div class="flex-1 px-6">
                        <div class="relative w-full max-w-4xl group">
                            <form action="<?php echo e(route('admin.search')); ?>" method="GET" class="relative"
                                id="header-search-form" data-search-url="<?php echo e(route('admin.search')); ?>">
                                <div class="relative">
                                    <input id="header-search-input" name="q" value="<?php echo e(request('q')); ?>" type="text"
                    ...
                    <div class="flex items-center gap-3 min-h-11">
                        <div class="relative" x-data="{
                            ...
                            latestIds: <?php echo e(json_encode($latestAdminNotifIds ?? [])); ?>,
                            unreadCount: 0,
                            hasUnread: false,
                            updateUnreadState() {
                            ...
                            <div x-show="open" x-transition:enter="transition ease-out duration-200"
                                ...
                                <div class="max-h-[400px] overflow-y-auto custom-scrollbar">
                                    <?php $__empty_1 = true; $__currentLoopData = $adminNotifItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notif): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <a href="<?php echo e($notif['url']); ?>" @click="markAsRead(<?php echo \Illuminate\Support\Js::from($notif['id'])->toHtml() ?>)"
                                            class="flex flex-col gap-1 p-5 hover:bg-slate-50 transition-all border-b border-slate-50 last:border-0 group relative"
                                            :class="!readIds.includes(<?php echo \Illuminate\Support\Js::from($notif['id'])->toHtml() ?>) ? 'bg-amber-50/30' : ''">
                                            <div class="flex items-center justify-between">
                                                <div class="flex items-center gap-2">
                                                    <template x-if="!readIds.includes(<?php echo \Illuminate\Support\Js::from($notif['id'])->toHtml() ?>)">
                                                        <span
                                                            class="w-1.5 h-1.5 bg-amber-500 rounded-full shadow-[0_0_8px_rgba(245,158,11,0.5)]"></span>
                                                    </template>
                                                    <span
                                                        class="material-symbols-outlined text-base text-primary"><?php echo e($notif['icon']); ?></span>
                                                    <h4
                                                        ...
                                                        <?php echo e($notif['title']); ?></h4>
                                                    <?php if(!empty($notif['needs_action'])): ?>
                                                        <span
                                                ...
                                                <span
                                                    class="text-[10px] font-bold text-slate-400 whitespace-nowrap ml-4"><?php echo e($notif['human_time']); ?></span>
                                            </div>
                        ...
                        <div class="flex items-center gap-2.5 min-h-10">
                            <div class="text-right hidden sm:flex sm:flex-col sm:justify-center leading-tight">
                                <div class="text-sm font-medium user-name dark:text-white"><?php echo e(auth()->user()->name); ?>
            ...
            <main class="relative flex-1 overflow-x-hidden overflow-y-auto bg-gray-100 p-6">
                <!-- Flash Messages -->
                <?php if(session('success') && !request()->has('_from_confirmation')): ?>
                    <div class="mb-4">
                        <!-- Success Alert -->
                                    ...
                                    <button type="button"
                                        ...
                                        <div class="flex items-center">
                                            ...
                                            <div class="text-left">
                                                ...
                                                <p class="text-sm text-red-600 mt-0.5"><?php echo e(count(session('failed_items'))); ?> item
                                                    gagal diproses</p>
                                            </div>
                                        </div>
                                    ...
                                    <div id="failed-items-content" class="hidden border-t border-red-200 bg-white">
                                        <div class="max-h-96 overflow-y-auto">
                                            <table class="w-full text-sm">
                                                <?php $__currentLoopData = session('failed_items'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <tr class="border-b border-red-100 hover:bg-red-50/50 transition">
                                                        <td class="px-4 py-3 text-red-700">
                                                            <div class="flex items-start">
                                                                <span
                                                                    class="inline-flex items-center justify-center h-5 w-5 rounded-full bg-red-100 text-red-600 flex-shrink-0 mr-3 mt-0.5 text-xs font-bold"><?php echo e($key + 1); ?></span>
                                                                <span class="break-words"><?php echo e($item); ?></span>
                                                            </div>
                                                        </td>
                                                    </tr>
                                        ...
                                        <div
                                            ...
                                            <p class="text-xs text-red-600 font-medium">Total gagal:
                                                <?php echo e(count(session('failed_items'))); ?> item
                                            </p>
                                            <div class="flex gap-2">
                                                ...
                                                <?php if(auth()->check() && Route::has('admin.jadwal-generate-logs')): ?>
                                                    <a href="<?php echo e(route('admin.jadwal-generate-logs')); ?>"
    ...
    <script>
        ...
        function downloadFailedItems() {
            const failedItems = <?php echo json_encode(session('failed_items') ?? [], 15, 512) ?>;
...
</html><?php /**PATH /Users/naradata/STIH-SIAKAD/resources/views/layouts/admin.blade.php ENDPATH**/ ?>