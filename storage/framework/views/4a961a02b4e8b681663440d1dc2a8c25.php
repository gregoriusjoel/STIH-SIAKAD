...
<div class="max-w-none mx-auto px-4 sm:px-6 lg:px-8 py-10">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
        <div>
            <a href="<?php echo e(route('mahasiswa.invoices.show', $invoice)); ?>" 
    ...
    <div class="grid grid-cols-1 gap-8">
            ...
            <div class="relative z-10 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                <div>
                    ...
                    <div class="flex items-baseline gap-2">
                        <span class="text-2xl font-bold">Cicilan Ke-<?php echo e($installment->installment_no); ?></span>
                        <span class="text-white/60 text-sm font-medium">Semester <?php echo e($invoice->semester); ?></span>
                    </div>
                    <p class="text-white/70 text-xs mt-1">TA <?php echo e($invoice->tahun_ajaran); ?></p>
                </div>
                <div class="text-left sm:text-right">
                    <h2 class="text-white/80 text-sm font-medium uppercase tracking-wider mb-1">Total Tagihan</h2>
                    <p class="text-3xl font-bold">Rp <?php echo e(number_format($installment->amount, 0, ',', '.')); ?></p>
                    <?php if($installment->due_date): ?>
                        <div class="inline-flex items-center gap-1.5 mt-2 px-3 py-1 bg-white/10 rounded-full backdrop-blur-sm border border-white/10">
                            ...
                            <span class="text-xs font-medium">Jatuh Tempo: <?php echo e($installment->due_date->format('d M Y')); ?></span>
                        </div>
                    <?php endif; ?>
                </div>
            </div>
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden">
            <div class="p-6 sm:p-8">
                <form action="<?php echo e(route('mahasiswa.payment-proofs.store')); ?>" method="POST" enctype="multipart/form-data" class="space-y-6">
                    <?php echo csrf_field(); ?>
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="relative">
                                ...
                                <input type="date" name="transfer_date" id="transfer_date" 
                                       ...
                                       class="block w-full pl-10 pr-3 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-slate-800 text-sm placeholder-slate-400 focus:outline-none focus:border-[#8B1538] focus:ring-1 focus:ring-[#8B1538] transition-colors <?php $__errorArgs = ['transfer_date'];
...
unset($__errorArgs, $__bag); ?>"
                                       value="<?php echo e(old('transfer_date', date('Y-m-d'))); ?>" required>
                            </div>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="relative">
                                ...
                                <input type="hidden" name="amount_submitted" id="amount_submitted_raw" value="<?php echo e(old('amount_submitted', $installment->amount)); ?>">
                                <input type="text" id="amount_submitted_display" 
                                       class="block w-full pl-10 pr-3 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-slate-800 text-sm font-medium placeholder-slate-400 focus:outline-none focus:border-[#8B1538] focus:ring-1 focus:ring-[#8B1538] transition-colors <?php $__errorArgs = ['amount_submitted'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                       value="<?php echo e(number_format(old('amount_submitted', $installment->amount), 0, ',', '.')); ?>" 
                                       inputmode="numeric"
                                       required>
                            </div>
                            <?php $__errorArgs = ['amount_submitted'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="relative">
                            ...
                            <select name="method" id="method" 
                                    required
                                    class="block w-full pl-10 pr-10 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-slate-800 text-sm focus:outline-none focus:border-[#8B1538] focus:ring-1 focus:ring-[#8B1538] transition-colors appearance-none <?php $__errorArgs = ['method'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                                ...
                                <option value="Transfer Bank" <?php echo e(old('method') == 'Transfer Bank' ? 'selected' : ''); ?>>Transfer Bank</option>
                                <option value="VA" <?php echo e(old('method') == 'VA' ? 'selected' : ''); ?>>Virtual Account</option>
                                <option value="E-Wallet" <?php echo e(old('method') == 'E-Wallet' ? 'selected' : ''); ?>>E-Wallet (OVO/Gopay/ShopeePay)</option>
                                <option value="Tunai" <?php echo e(old('method') == 'Tunai' ? 'selected' : ''); ?>>Tunai / Teller</option>
                            </select>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="space-y-2">
                        ...
                        <textarea name="student_notes" id="student_notes" rows="3"
                                  ...
                                  placeholder="Tambahkan catatan jika diperlukan..."><?php echo e(old('student_notes')); ?></textarea>
                    </div>
...
<?php echo $__env->make('layouts.mahasiswa', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/naradata/STIH-SIAKAD/resources/views/page/mahasiswa/pembayaran/payment-proofs/create.blade.php ENDPATH**/ ?>