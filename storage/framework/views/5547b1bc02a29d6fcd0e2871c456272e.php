    ...
    <div class="w-full">
        <div class="bg-white rounded-xl shadow-lg overflow-hidden ">
            <div class="p-6 border-b border-gray-200 bg-maroon text-white">
                ...
                <p class="text-sm mt-1 text-white text-opacity-90">Perbarui data mahasiswa <?php echo e($mahasiswa->user->name); ?></p>
            </div>

            <form action="<?php echo e(route('admin.mahasiswa.update', $mahasiswa)); ?>" method="POST" class="p-6 edit-form">
                <?php echo csrf_field(); ?>
                    ...
                    <div class="border-b pb-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="text" name="name" value="<?php echo e(old('name', $mahasiswa->user->name)); ?>"
                            ...
                            <div>
                                ...
                                <input type="email" name="email_pribadi"
                                    value="<?php echo e(old('email_pribadi', $mahasiswa->email_pribadi)); ?>"
                                    class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-maroon focus:border-transparent transition"
                            ...
                            <div>
                                ...
                                <input type="email" name="email_kampus"
                                    value="<?php echo e(old('email_kampus', $mahasiswa->email_kampus)); ?>"
                                    class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-maroon focus:border-transparent transition"
                            ...
                            <div>
                                ...
                                <select name="email_aktif"
                                    ...
                                    <option value="pribadi" <?php echo e(old('email_aktif', $mahasiswa->email_aktif) == 'pribadi' ? 'selected' : ''); ?>>Email Pribadi</option>
                                    <option value="kampus" <?php echo e(old('email_aktif', $mahasiswa->email_aktif) == 'kampus' ? 'selected' : ''); ?>>Email Kampus</option>
                                </select>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <select name="prodi"
                                    ...
                                    <?php $__currentLoopData = $prodis; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $prodi): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($prodi->nama_prodi); ?>" <?php echo e(old('prodi', $mahasiswa->prodi) == $prodi->nama_prodi ? 'selected' : ''); ?>>
                            ...
                            <div>
                                ...
                                <select name="angkatan"
                                    ...
                                    <?php for($year = date('Y'); $year >= 1960; $year--): ?>
                                        <option value="<?php echo e($year); ?>" <?php echo e(old('angkatan', $mahasiswa->angkatan) == $year ? 'selected' : ''); ?>><?php echo e($year); ?></option>
                                    <?php endfor; ?>
                                </select>
                            </div>
                            ...
                            <div>
                                ...
                                <select name="semester" required
                                    class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-maroon focus:border-transparent transition">
                                    <?php for($i = 1; $i <= 8; $i++): ?>
                                        <option value="<?php echo e($i); ?>" <?php echo e(old('semester', $mahasiswa->semester ?? 1) == $i ? 'selected' : ''); ?>>Semester <?php echo e($i); ?></option>
                                    <?php endfor; ?>
                                </select>
                            </div>
                            ...
                            <div>
                                ...
                                <select name="status"
                                    class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-maroon focus:border-transparent transition"
                                    required>
                                    <option value="aktif" <?php echo e(old('status', $mahasiswa->status) == 'aktif' ? 'selected' : ''); ?>>Aktif</option>
                                    <option value="cuti" <?php echo e(old('status', $mahasiswa->status) == 'cuti' ? 'selected' : ''); ?>>
                                        Cuti</option>
                                    <option value="lulus" <?php echo e(old('status', $mahasiswa->status) == 'lulus' ? 'selected' : ''); ?>>Lulus</option>
                                    <option value="drop-out" <?php echo e(old('status', $mahasiswa->status) == 'drop-out' ? 'selected' : ''); ?>>Drop Out</option>
                                </select>
                            </div>
                            ...
                            <div class="md:col-span-2">
                                ...
                                <textarea name="address" rows="3"
                                    class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-maroon focus:border-transparent transition"
                                    placeholder="Alamat lengkap mahasiswa"><?php echo e(old('address', $mahasiswa->address)); ?></textarea>
                            </div>
                        </div>
                    </div>
                </div>
                                ...
                                .then(response => {
                                    if (response.redirected || response.ok) {
                                        Swal.fire({
                                            ...
                                            window.location.href = "<?php echo e(route('admin.mahasiswa.index')); ?>";
                                        });
                                    } else {
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/naradata/STIH-SIAKAD/resources/views/admin/mahasiswa/edit.blade.php ENDPATH**/ ?>