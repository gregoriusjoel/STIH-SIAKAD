    ...
    <div class="flex-1 overflow-y-auto overflow-x-hidden custom-scrollbar py-6 px-4 space-y-1 border-r border-gray-100 dark:border-gray-800">
        ...
        <div class="space-y-1">
            <?php $__currentLoopData = $navItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php $isActive = $item['active'] !== '#' && Request::routeIs($item['active']); ?>
                <a href="<?php echo e($item['route'] === '#' ? '#' : route($item['route'])); ?>"
                   class="<?php echo e($navItemClass); ?> <?php echo e($isActive ? $activeClass : $inactiveClass); ?>">
                    <i class="fas <?php echo e($item['icon']); ?> w-5 text-center transition-transform group-hover:scale-110"></i>
                    <span class="tracking-wide"><?php echo e($item['label']); ?></span>
                    <?php if($isActive): ?>
...
</style><?php /**PATH /Users/naradata/STIH-SIAKAD/resources/views/layouts/partials/sidebar-finance.blade.php ENDPATH**/ ?>