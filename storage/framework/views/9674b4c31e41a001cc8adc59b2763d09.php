<?php $__env->startSection('title', 'Tambah Jam Perkuliahan'); ?>
<?php $__env->startSection('page-title', 'Tambah Jam Perkuliahan'); ?>
...
<?php $__env->startSection('content'); ?>
    <div class="w-full">
        <div class="bg-white rounded-xl shadow-lg overflow-hidden ">
            ...
            <form action="<?php echo e(route('admin.jam-perkuliahan.store')); ?>" method="POST" class="p-6">
                <?php echo csrf_field(); ?>
                ...
                <div class="space-y-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="number" name="jam_ke" id="jam_ke" value="<?php echo e(old('jam_ke', $suggestedJamKe)); ?>"
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input type="time" name="jam_mulai" id="jam_mulai"
                                value="<?php echo e(old('jam_mulai', $suggestedJamMulai)); ?>"
                                class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-maroon focus:border-transparent transition"
                                required>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input type="time" name="jam_selesai" id="jam_selesai" value="<?php echo e(old('jam_selesai')); ?>"
                                class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-maroon focus:border-transparent transition"
                                required>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="flex justify-end space-x-3 mt-8 pt-6 border-t">
                    <a href="<?php echo e(route('admin.jam-perkuliahan.index')); ?>"
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/naradata/STIH-SIAKAD/resources/views/admin/jam-perkuliahan/create.blade.php ENDPATH**/ ?>