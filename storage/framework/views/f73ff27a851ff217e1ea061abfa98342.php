            ...
            <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700 border-separate"
                ...
                <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                    <?php $__empty_1 = true; $__currentLoopData = $mahasiswas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mahasiswa): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr class="hover:bg-blue-50 dark:hover:bg-blue-900/20 transition cursor-pointer" @click="selectedMahasiswa = <?php echo e(Js::from([
                            'nim' => $mahasiswa->nim,
                            ...
                            'foto' => $mahasiswa->foto ? \App\Helpers\FileHelper::fileUrl($mahasiswa->foto) : null,
                                        ...
                                        :class="{ 'bg-blue-50 dark:bg-blue-900/30': selectedMahasiswa && selectedMahasiswa.nim === '<?php echo e($mahasiswa->nim); ?>' }">
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900 dark:text-gray-100 font-medium">
                                            <?php echo e(($mahasiswas->currentPage() - 1) * $mahasiswas->perPage() + $loop->iteration); ?>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="flex items-center">
                                                <div
                                                    ...
                                                    <?php echo e(strtoupper(substr($mahasiswa->user->name, 0, 1))); ?>

                                                </div>
                                                <span
                                                    class="text-sm font-medium text-gray-900 dark:text-gray-100"><?php echo e($mahasiswa->user->name); ?></span>
                                            </div>
                                        </td>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 dark:text-gray-400">
                                            ...
                                            <?php echo e($mahasiswa->angkatan); ?>

                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap text-center">
                                            <span
                                                class="px-3 py-1 inline-flex items-center justify-center mx-auto text-xs leading-5 font-semibold rounded-full 
                                                                <?php echo e($mahasiswa->status == 'aktif' ? 'bg-green-100 dark:bg-green-900/30 text-green-800 dark:text-green-300' : ''); ?>

                                                                <?php echo e($mahasiswa->status == 'cuti' ? 'bg-yellow-100 dark:bg-yellow-900/30 text-yellow-800 dark:text-yellow-300' : ''); ?>

                                                                <?php echo e($mahasiswa->status == 'lulus' ? 'bg-blue-100 dark:bg-blue-900/30 text-blue-800 dark:text-blue-300' : ''); ?>

                                                                <?php echo e($mahasiswa->status == 'drop-out' ? 'bg-red-100 dark:bg-red-900/30 text-red-800 dark:text-red-300' : ''); ?>">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                            <div class="flex items-center space-x-2" @click.stop>
                                                <a href="<?php echo e(route('admin.mahasiswa.show', $mahasiswa)); ?>"
                                                ...
                                                <form action="<?php echo e(route('admin.mahasiswa.destroy', $mahasiswa)); ?>" method="POST"
        ...
        <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl w-full max-w-4xl max-h-[90vh] flex flex-col mx-4">
            ...
            <div class="flex items-center justify-between px-6 py-4 bg-maroon text-white rounded-t-2xl flex-shrink-0">
                ...
                <div class="flex items-center gap-3">
                    <a href="<?php echo e(route('admin.import.template', ['type' => 'mahasiswa', 'format' => 'xlsx'])); ?>"
                        data-no-loader
                    ...
                    <a href="<?php echo e(route('admin.import.template', ['type' => 'mahasiswa', 'format' => 'csv'])); ?>"
                        data-no-loader
                        class="text-xs bg-white/20 hover:bg-white/30 px-3 py-1.5 rounded-lg transition flex items-center gap-1.5">
            ...
            <div class="flex-1 overflow-y-auto p-6 space-y-5">
                ...
                <div id="imp-columns-info"
                    ...
                    <div class="flex flex-wrap gap-2">
                        ...
                        ?>
                        <?php $__currentLoopData = $columns; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $display => $actual): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <span
                                class="px-2 py-1 text-xs rounded-lg <?php echo e(in_array($actual, $required) ? 'bg-red-100 dark:bg-red-900/30 text-red-700 dark:text-red-400 font-semibold' : 'bg-gray-100 dark:bg-gray-600 text-gray-600 dark:text-gray-400'); ?>">
                                <?php echo e($display); ?><?php echo e(in_array($actual, $required) ? '*' : ''); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/naradata/STIH-SIAKAD/resources/views/admin/mahasiswa/index.blade.php ENDPATH**/ ?>