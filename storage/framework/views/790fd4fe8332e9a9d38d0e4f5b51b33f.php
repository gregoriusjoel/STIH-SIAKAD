<div class="bg-bg-card rounded-xl shadow-sm overflow-hidden">
    <div class="px-6 py-4 border-b border-border-color flex items-start justify-between gap-6">
        ...
        <div class="ml-auto">
            <a href="<?php echo e(route('mahasiswa.nilai.print')); ?>" target="_blank"
        ...
        <div class="overflow-x-auto">
            <table class="w-full min-w-[800px] text-sm">
                ...
                <tbody class="divide-y divide-border-color">
                    <?php $__currentLoopData = $all; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $krs): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php
                        ...
                        <tr class="hover:bg-bg-hover transition-colors">
                            <td class="px-4 py-3 text-text-primary font-medium"><?php echo e($mataKuliah->kode_mk ?? '-'); ?></td>
                            <td class="px-4 py-3 text-text-primary"><?php echo e($mataKuliah->nama_mk ?? '-'); ?></td>
                            <td class="px-4 py-3 text-text-secondary"><?php echo e(strtoupper(str_replace('_', ' ', $jenis))); ?></td>
                            <td class="px-4 py-3 text-center text-text-primary font-semibold"><?php echo e($sks); ?></td>
                            <td class="px-4 py-3 text-center text-text-primary font-bold"><?php echo e($nilaiAngka); ?></td>
                            <td class="px-4 py-3 text-center text-text-secondary"><?php echo e($sem); ?></td>
                        </tr>
            ...
            <div class="mt-4 pt-4 border-t border-border-color">
                <div class="flex flex-col sm:flex-row items-center justify-between gap-3 text-sm">
                    <div class="text-text-secondary">
                        <span class="font-semibold"><?php echo e($totalMk); ?></span> Matakuliah
                    </div>
                    <div class="text-text-secondary">
                        Total SKS: <span class="font-semibold"><?php echo e($totalSksCalc); ?></span>
                    </div>
                    <div class="text-text-secondary">
                        IPK: <span class="font-bold text-maroon"><?php echo e(number_format($ipkVal, 2)); ?></span>
                    </div>
                </div>
            </div>
        </div>
    </div>
</div><?php /**PATH /Users/naradata/STIH-SIAKAD/resources/views/page/mahasiswa/khs/_content.blade.php ENDPATH**/ ?>