...
<div class="space-y-8 animate-fade-in px-4 md:px-0 pb-12">
    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <div class="flex items-center gap-2">
            <a href="<?php echo e(route('finance.laporan.index')); ?>"
    ...
    <form method="GET" action="<?php echo e(route('finance.laporan.index')); ?>"
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            <div>
                ...
                <select name="tahun_ajaran"
                    ...
                    <?php $__currentLoopData = $tahunAjaranOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ta): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <div>
                ...
                <select name="semester"
                    ...
                    <?php for($i = 1; $i <= 8; $i++): ?>
                        <option value="<?php echo e($i); ?>" <?php echo e($semester == $i ? 'selected' : ''); ?>>Semester <?php echo e($i); ?></option>
                    <?php endfor; ?>
                </select>
            </div>
            <div>
            ...
            <div>
                ...
                <select name="status"
                    ...
                    <option value="PUBLISHED" <?php echo e($status == 'PUBLISHED' ? 'selected' : ''); ?>>Belum Bayar</option>
                    <option value="IN_INSTALLMENT" <?php echo e($status == 'IN_INSTALLMENT' ? 'selected' : ''); ?>>Cicilan</option>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-5">
        ...
        <?php $__currentLoopData = $kpis; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kpi): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="bg-white rounded-2xl border border-slate-100 shadow-sm overflow-hidden ring-1 <?php echo e($kpi['ring']); ?> hover:shadow-lg transition-all group">
                <div class="p-6">
                    <div class="flex items-start justify-between mb-4">
                        <div class="size-12 rounded-2xl bg-gradient-to-br <?php echo e($kpi['gradient']); ?> flex items-center justify-center text-white shadow-md">
                            <i class="fas <?php echo e($kpi['icon']); ?> text-lg"></i>
                        </div>
                        <span class="text-[9px] font-black uppercase tracking-[0.2em] text-slate-400 mt-1"><?php echo e($kpi['label']); ?></span>
                    </div>
                    <p class="text-xl font-black text-slate-800 tracking-tight leading-tight"><?php echo e($kpi['value']); ?></p>
                    <p class="text-xs text-slate-400 font-medium mt-1"><?php echo e($kpi['sub']); ?></p>
                </div>
                <div class="h-1 bg-gradient-to-r <?php echo e($kpi['gradient']); ?> opacity-40 group-hover:opacity-100 transition-opacity"></div>
            </div>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="bg-white rounded-2xl border border-slate-100 shadow-sm p-6">
            ...
            <div class="mt-6 space-y-3">
                <?php $__empty_1 = true; $__currentLoopData = $statusBreakdown; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <?php
                    ...
                    <div class="flex items-center justify-between">
                        <div class="flex items-center gap-2">
                            <div class="w-3 h-3 rounded-full <?php echo e($cfg['color']); ?>"></div>
                            <span class="text-xs font-bold text-slate-600"><?php echo e($cfg['label']); ?></span>
                        </div>
                        <div class="text-right">
                            <span class="text-xs font-black text-slate-800"><?php echo e($item->jumlah); ?> invoice</span>
                            <span class="text-[10px] text-slate-400 ml-1">(<?php echo e($pct); ?>%)</span>
                        </div>
                    </div>
                    <div class="w-full h-1.5 bg-slate-100 rounded-full overflow-hidden">
                        <div class="h-full rounded-full <?php echo e($cfg['color']); ?>" style="width: <?php echo e($pct); ?>%"></div>
                    </div>
    ...
    <div class="bg-white rounded-2xl border border-slate-100 shadow-sm overflow-hidden">
        <div class="px-6 py-5 border-b border-slate-50 flex items-center justify-between">
            <div>
                ...
                <p class="text-xs text-slate-400 font-medium"><?php echo e($invoices->total()); ?> tagihan ditemukan</p>
            </div>
        </div>
                ...
                <tbody class="divide-y divide-slate-50">
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $invoices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $invoice): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        ...
                        <tr class="hover:bg-slate-50/50 transition-colors">
                            <td class="px-6 py-5">
                                <span class="text-sm font-bold text-slate-400">#<?php echo e($invoice->id); ?></span>
                            </td>
                            <td class="px-6 py-5">
                                <div class="flex items-center gap-3">
                                    <div class="size-9 rounded-xl bg-gradient-to-br from-[#8B1538] to-[#6D1029] text-white flex items-center justify-center font-black text-sm shrink-0">
                                        <?php echo e(strtoupper(substr($invoice->student->user->name ?? 'M', 0, 1))); ?>

                                    </div>
                                    <div class="min-w-0">
                                        <p class="text-sm font-bold text-slate-800 truncate"><?php echo e($invoice->student->user->name ?? 'N/A'); ?></p>
                                        <p class="text-[10px] text-slate-400 font-medium"><?php echo e($invoice->student->nim ?? '-'); ?></p>
                                    </div>
                                </div>
                            </td>
                            <td class="px-6 py-5">
                                <p class="text-sm font-bold text-slate-700">Semester <?php echo e($invoice->semester); ?></p>
                                <p class="text-[10px] font-black text-slate-400 uppercase tracking-widest"><?php echo e($invoice->tahun_ajaran); ?></p>
                            </td>
                            <td class="px-6 py-5 text-right">
                                <p class="text-sm font-black text-slate-800">Rp <?php echo e(number_format($invoice->total_tagihan, 0, ',', '.')); ?></p>
                            </td>
                            <td class="px-6 py-5 text-right">
                                <p class="text-sm font-black <?php echo e($terbayar >= $invoice->total_tagihan ? 'text-emerald-600' : ($terbayar > 0 ? 'text-amber-600' : 'text-slate-400')); ?>">
                                    Rp <?php echo e(number_format($terbayar, 0, ',', '.')); ?>

                                </p>
                                <div class="mt-1.5 w-24 ml-auto h-1.5 bg-slate-100 rounded-full overflow-hidden">
                                    <div class="h-full rounded-full <?php echo e($terbayar >= $invoice->total_tagihan ? 'bg-emerald-500' : ($terbayar > 0 ? 'bg-amber-400' : 'bg-slate-300')); ?>"
                                         style="width: <?php echo e($pctBayar); ?>%"></div>
                                </div>
                            </td>
                            <td class="px-6 py-5 text-center">
                                <span class="px-2.5 py-1.5 rounded-xl text-[10px] font-black uppercase tracking-widest border <?php echo e($sClass); ?>">
                                    <?php echo e($sLabel); ?>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const trendOptions = {
        ...
        series: [{
            name: 'Dana Masuk',
            data: <?php echo json_encode($trendValues, 15, 512) ?>
        }],
        xaxis: {
    ...
    const donutOptions = {
        ...
        colors: <?php echo json_encode(array_slice($donutColors, 0, count($donutValues))) ?>,
        legend: { show: false },
        dataLabels: { enabled: false },
        plotOptions: {
            pie: {
...
<?php echo $__env->make('layouts.finance', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/naradata/STIH-SIAKAD/resources/views/finance/laporan/index.blade.php ENDPATH**/ ?>