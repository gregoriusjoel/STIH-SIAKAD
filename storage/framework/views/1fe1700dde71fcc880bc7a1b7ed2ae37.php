...
<?php $__env->startSection('page-title', 'E-Learning'); ?>
            ...
            <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
                ...
                <div class="flex items-center gap-3">
                    <div class="bg-blue-50 text-blue-700 px-4 py-2 rounded-lg text-sm font-medium">
                        Total SKS: <?php echo e(collect($classes)->sum('sks')); ?>

                    </div>
                    <div class="bg-purple-50 text-purple-700 px-4 py-2 rounded-lg text-sm font-medium">
                        Total Kelas: <?php echo e(count($classes)); ?>
                ...
                <?php $__currentLoopData = $classes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $class): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div
                        ...
                        <div class="bg-gradient-to-r from-maroon to-red-900 p-4 text-white relative overflow-hidden">
                            <div class="relative z-10">
                                <div class="flex justify-between items-start mb-2">
                                    <?php if(!empty($class['kode_mk'])): ?>
                                        <span class="bg-white/20 px-2 py-1 rounded text-xs font-medium backdrop-blur-sm">
                                            <?php echo e($class['kode_mk']); ?>

                                        </span>
                                    <?php endif; ?>
                                    <span class="bg-white/20 px-2 py-1 rounded text-xs font-medium backdrop-blur-sm">
                                        <?php echo e($class['sks']); ?> SKS
                                    </span>
                                </div>
                                <h3 class="font-bold text-lg leading-tight mb-1 line-clamp-2" title="<?php echo e($class['mata_kuliah']); ?>">
                                    <?php echo e($class['mata_kuliah']); ?>

                                </h3>
                                <p class="text-red-100 text-sm">Kelas <?php echo e($class['section']); ?></p>
                            </div>
                        </div>
                        ...
                        <div class="p-5 space-y-4">
                            ...
                            <div class="space-y-3">
                                <div class="flex items-start gap-3 text-gray-600">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-sm font-medium text-gray-800 line-clamp-1"><?php echo e($class['dosen']); ?></p>
                                    </div>
                                </div>
                                ...
                                <div class="flex items-start gap-3 text-gray-600">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-sm font-medium text-gray-800"><?php echo e($class['hari']); ?>, <?php echo e($class['jam']); ?></p>
                                        <p class="text-xs text-gray-500">Ruang: <?php echo e($class['ruangan']); ?></p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <!-- Action Button -->
                            <div class="pt-2">
                                <a href="<?php echo e(route('mahasiswa.kelas.show', $class['id'])); ?>"
...
<?php echo $__env->make('layouts.mahasiswa', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/naradata/STIH-SIAKAD/resources/views/page/mahasiswa/kelas/index.blade.php ENDPATH**/ ?>