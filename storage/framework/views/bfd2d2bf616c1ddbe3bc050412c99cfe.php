<?php $__env->startSection('title', 'Kelas Perkuliahan'); ?>
    ...
    <div x-data="{ showGenerateModal: false }">
        ...
        <div class="mb-6 flex flex-col md:flex-row md:items-start md:justify-between gap-4">
            <div>
                ...
                <p class="text-sm text-gray-600 mt-1">Kelola data kelas berdasarkan tingkat dan program studi. Format: <code
                        class="px-1.5 py-0.5 bg-gray-100 rounded text-maroon font-semibold">[Tingkat][Kode Prodi][Kode Kelas]</code>
                </p>
            </div>
            <div class="flex flex-wrap gap-2">
                ...
                <a href="<?php echo e(route('admin.kelas-perkuliahan.create')); ?>"
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-4 mb-6">
            <form method="GET" action="<?php echo e(route('admin.kelas-perkuliahan.index')); ?>" class="flex flex-wrap gap-4 items-end">
                    ...
                    <select name="prodi_id"
                        ...
                        <?php $__currentLoopData = $prodis; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $prodi): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($prodi->id); ?>" <?php echo e(request('prodi_id') == $prodi->id ? 'selected' : ''); ?>>
                                <?php echo e($prodi->nama_prodi); ?></option>
                ...
                <div class="min-w-[120px]">
                    ...
                    <select name="tingkat"
                        ...
                        <?php for($i = 1; $i <= 8; $i++): ?>
                            <option value="<?php echo e($i); ?>" <?php echo e(request('tingkat') == $i ? 'selected' : ''); ?>>
                                Tingkat <?php echo e($i); ?> (Sms <?php echo e(($i * 2) - 1); ?> & <?php echo e($i * 2); ?>)
                            </option>
                        <?php endfor; ?>
                    </select>
                </div>
                <div class="min-w-[200px]">
                    ...
                    <select name="tahun_akademik_id"
                        ...
                        <?php $__currentLoopData = $semesters; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($sem->id); ?>" <?php echo e(request('tahun_akademik_id') == $sem->id ? 'selected' : ''); ?>>
                                <?php echo e($sem->nama_semester); ?> <?php echo e($sem->tahun_ajaran); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                </div>
        ...
        <div class="bg-white rounded-xl shadow-lg  overflow-hidden">
            <div class="overflow-x-auto">
                <table class="w-full">
                    ...
                    <tbody class="divide-y divide-gray-200">
                        <?php $__empty_1 = true; $__currentLoopData = $kelasPerkuliahans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr class="hover:bg-blue-50 transition duration-200">
                                <td class="px-6 py-4">
                                    <span
                                        class="inline-flex items-center px-3 py-1 rounded-full text-sm font-bold bg-blue-100 text-blue-800">
                                        <i class="fas fa-layer-group mr-1.5"></i><?php echo e($kp->nama_kelas); ?>
                                ...
                                <td class="px-6 py-4">
                                    <span
                                        ...
                                        Tingkat <?php echo e($kp->tingkat); ?>

                                    </span>
                                </td>
                                <td class="px-6 py-4">
                                    <div class="font-semibold text-gray-900"><?php echo e($kp->prodi?->nama_prodi ?? '-'); ?></div>
                                    <div class="text-xs text-gray-500"><?php echo e($kp->kode_prodi); ?></div>
                                </td>
                                <td class="px-6 py-4 font-mono font-semibold text-gray-700"><?php echo e($kp->kode_kelas); ?></td>
                                <td class="px-6 py-4 text-sm text-gray-600">
                                    <?php if($kp->tahunAkademik): ?>
                                        <?php echo e($kp->tahunAkademik->nama_semester); ?> <?php echo e($kp->tahunAkademik->tahun_ajaran); ?>
                                ...
                                <td class="px-6 py-4 text-center">
                                    <div class="flex items-center justify-center gap-2">
                                        <a href="<?php echo e(route('admin.kelas-perkuliahan.show', $kp)); ?>"
                                            class="text-blue-600 hover:text-blue-800 transition" title="Detail">
                                            <i class="fas fa-eye"></i>
                                        </a>
                                        <a href="<?php echo e(route('admin.kelas-perkuliahan.edit', $kp)); ?>"
                                            class="text-yellow-600 hover:text-yellow-800 transition" title="Edit">
                                            <i class="fas fa-edit"></i>
                                        </a>
                                        <form method="POST" action="<?php echo e(route('admin.kelas-perkuliahan.destroy', $kp)); ?>"
                                            class="inline"
                                            onsubmit="return confirm('Yakin hapus kelas <?php echo e($kp->nama_kelas); ?>?')">
                                            <?php echo csrf_field(); ?>
            ...
            <?php if($kelasPerkuliahans->hasPages()): ?>
                <div class="px-6 py-4 border-t border-gray-200 bg-gray-50"><?php echo e($kelasPerkuliahans->links()); ?></div>
            <?php endif; ?>
        </div>
        ...
        <div x-show="showGenerateModal" x-transition:enter="transition ease-out duration-200"
            ...
            <div @click.away="showGenerateModal = false"
                class="bg-white rounded-2xl shadow-2xl w-full max-w-7xl max-h-[95vh] overflow-y-auto flex flex-col">
                <div class="bg-maroon p-4 text-white sticky top-0 z-10">
                    <h3 class="text-lg font-bold flex items-center"><i class="fas fa-magic mr-2"></i>Generate Kelas Massal
                    </h3>
                    <p class="text-sm opacity-80 mt-1">Generate kelas perkuliahan secara otomatis berdasarkan program studi
                    </p>
                </div>
                <form method="POST" action="<?php echo e(route('admin.kelas-perkuliahan.generate-bulk')); ?>"
                    class="p-5 space-y-3 flex-1 overflow-y-auto">
                    <?php echo csrf_field(); ?>
                    <div class="grid grid-cols-3 gap-3">
                        <div>
                            <label class="block text-sm font-semibold text-gray-700 mb-1.5">Program Studi <span
                        ...
                        <div>
                            ...
                            <select name="tahun_akademik_id"
                                ...
                                <?php $__currentLoopData = $semesters; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($sem->id); ?>"><?php echo e($sem->nama_semester); ?> <?php echo e($sem->tahun_ajaran); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </div>
                        <div>
                            <label class="block text-sm font-semibold text-gray-700 mb-1.5">Jumlah Tingkat <span
                                    class="text-red-500">*</span></label>
                    ...
                    <div x-data="{ mode: 'manual', maxPerKelas: 40 }">
                        <label class="block text-sm font-semibold text-gray-700 mb-1.5">Mode Generate <span
                                class="text-red-500">*</span></label>
                        <div class="grid grid-cols-2 gap-2 mb-2">
                            <label
                                class="flex items-center gap-2 p-2 rounded-lg border border-gray-200 cursor-pointer text-sm"
                                :class="mode === 'manual' ? 'bg-maroon/5 border-maroon' : 'hover:bg-gray-50'">
                            ...
                            <label
                                class="flex items-center gap-2 p-2 rounded-lg border border-gray-200 cursor-pointer text-sm"
                                :class="mode === 'auto' ? 'bg-maroon/5 border-maroon' : 'hover:bg-gray-50'">
                        ...
                        <div x-show="mode === 'manual'" class="space-y-2">
                            <div>
                                <label class="block text-sm font-semibold text-gray-700 mb-1.5">Kelas per Tingkat <span
                                        class="text-red-500">*</span></label>
                        ...
                        <div x-show="mode === 'auto'" class="space-y-3">
                            <div>
                                <label class="block text-sm font-semibold text-gray-700 mb-1.5">Maks Siswa/Kelas <span
                                        class="text-red-500">*</span></label>
                                <input type="number" name="max_students_per_class" x-model="maxPerKelas" min="1" max="100"
                                    value="40"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-maroon focus:border-transparent">
                            </div>
                        ...
                        <div x-data="{ overwrite: false }">
                            <label
                                class="flex items-center gap-3 p-3 rounded-lg bg-gray-50 border border-gray-200 cursor-pointer hover:bg-gray-100 transition text-sm">
                                <input type="checkbox" name="overwrite" x-model="overwrite"
                                    class="w-4 h-4 text-maroon rounded focus:ring-2 focus:ring-maroon">
                    ...
                    <div class="flex justify-end gap-3 pt-3 border-t sticky bottom-0 bg-white">
                        <button type="button" @click="showGenerateModal = false"
                            class="px-4 py-2 border border-gray-300 text-gray-700 rounded-lg text-sm font-medium hover:bg-gray-50 transition">Batal</button>
                        <button type="submit"
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/naradata/STIH-SIAKAD/resources/views/admin/kelas-perkuliahan/index.blade.php ENDPATH**/ ?>