...
<?php $__env->startSection('content'); ?>
    ...
    <div class="dashboard-hero dashboard-soft-glow relative overflow-hidden rounded-2xl mb-6 p-5 md:p-6 text-white shadow-xl"
        ...
        <div class="relative flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
            <div>
                ...
                <p class="text-sm text-white/85 mt-1"><?php echo e($todayLabel); ?> - Ringkasan cepat kondisi akademik STIH</p>
            </div>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
        ...
        <div
            ...
            <div class="grid grid-cols-2 gap-3 relative z-10">
                <!-- Mahasiswa Card -->
                <a href="<?php echo e(route('admin.mahasiswa.index')); ?>" class="group block">
                    <div
                        ...
                        <div>
                            ...
                            <h4 class="text-2xl font-bold text-gray-900 dark:text-white mb-3"><?php echo e($total_mahasiswa); ?></h4>
                        </div>
                ...
                <!-- Orang Tua Card -->
                <a href="<?php echo e(route('admin.parents.index')); ?>" class="group block">
                    <div
                        ...
                        <div>
                            ...
                            <h4 class="text-2xl font-bold text-gray-900 dark:text-white mb-3"><?php echo e($total_parent); ?></h4>
                        </div>
        ...
        <div
            ...
            <div class="grid grid-cols-2 gap-3 relative z-10">
                <!-- Dosen Card -->
                <a href="<?php echo e(route('admin.dosen.index')); ?>" class="group block">
                    <div
                        ...
                        <div>
                            ...
                            <h4 class="text-2xl font-bold text-gray-900 dark:text-white mb-3"><?php echo e($total_dosen); ?></h4>
                        </div>
                ...
                <!-- Mata Kuliah Card -->
                <a href="<?php echo e(route('admin.mata-kuliah.index')); ?>" class="group block">
                    <div
                        ...
                        <div>
                            ...
                            <h4 class="text-2xl font-bold text-gray-900 dark:text-white mb-3"><?php echo e($total_mata_kuliah); ?></h4>
                        </div>
        ...
        <div
            ...
            <div class="grid grid-cols-2 gap-3 relative z-10">
                <!-- Kelas Card -->
                <a href="<?php echo e(route('admin.kelas-mata-kuliah.index')); ?>" class="group block">
                    <div
                        ...
                        <div>
                            ...
                            <h4 class="text-2xl font-bold text-gray-900 dark:text-white mb-3"><?php echo e($total_kelas); ?></h4>
                        </div>
                ...
                <a href="<?php echo e(route('admin.jadwal.index')); ?>" class="group block">
                    <div
                        ...
                        <div>
                            ...
                            <h4 class="text-2xl font-bold text-gray-900 dark:text-white mb-3"><?php echo e($total_jadwal); ?></h4>
                        </div>
    ...
    <div class="grid grid-cols-1 xl:grid-cols-2 gap-4 mt-2">
        <?php if($calendarActivePeriods->count() > 0): ?>
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 p-4">
                <div class="flex items-center gap-2 mb-3">
                    ...
                    <span
                        ...
                        <?php echo e($calendarActivePeriods->count()); ?> periode
                    </span>
                </div>

                <div class="grid grid-cols-1 gap-3">
                    <?php $__currentLoopData = $calendarActivePeriods; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $period): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php
                        ...
                        <div
                            ...
                            <p class="text-sm font-bold text-gray-800 dark:text-gray-100 line-clamp-1" title="<?php echo e($period->title); ?>">
                                <?php echo e($period->title); ?></p>
                            <p class="text-[11px] text-gray-500 dark:text-gray-400 mt-1 flex items-center gap-1.5">
                                <i class="fas fa-clock text-maroon/70"></i>
                                <span class="truncate"><?php echo e($dateRangeText); ?></span>
                            </p>
        ...
        <div
            class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 <?php echo e($calendarActivePeriods->count() > 0 ? '' : 'xl:col-span-2'); ?>">
            ...
            <div class="p-4">
                <?php if($academic_events->count() > 0 || $calendarActivePeriods->count() > 0): ?>
                    <?php
                    ...
                    <div class="flex items-center justify-between mb-3">
                        <div class="flex items-center gap-2">
                            <a href="<?php echo e($prevMonthUrl); ?>"
                            ...
                            <h4 class="text-sm font-bold text-gray-800 dark:text-gray-100 min-w-[110px] text-center">
                                <?php echo e($monthStart->translatedFormat('F Y')); ?></h4>
                            <a href="<?php echo e($nextMonthUrl); ?>"
                                class="inline-flex items-center justify-center w-7 h-7 rounded-lg border border-maroon/20 text-maroon hover:bg-maroon/10 dark:text-red-200 dark:border-red-900/40 dark:hover:bg-red-900/30"
                        ...
                        <span
                            ...
                            <?php echo e($monthAgendaCount); ?> agenda
                        </span>
                    </div>

                    <div class="grid grid-cols-7 gap-1 mb-1">
                        <?php $__currentLoopData = $weekDays; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dayName): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div
                                class="text-[10px] font-bold uppercase tracking-wide text-gray-500 dark:text-gray-400 text-center py-1">
                                <?php echo e($dayName); ?></div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>

                    <div class="grid grid-cols-7 gap-1">
                        <?php $__currentLoopData = $dayCells; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cell): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php
                                $eventCount = count($cell['events']);
                            ?>
                            <div x-data="{ open: false }" @mouseenter="open = true" @mouseleave="open = false"
                                class="relative min-h-[78px] rounded-lg border p-1.5 <?php echo e($cell['in_month'] ? 'bg-white dark:bg-gray-800 border-gray-100 dark:border-gray-700' : 'bg-gray-50 dark:bg-gray-900/30 border-gray-100 dark:border-gray-800 opacity-70'); ?> <?php echo e($cell['is_today'] ? 'ring-1 ring-maroon/40 border-maroon/30 dark:border-red-800' : ''); ?>">
                                <div class="flex items-center justify-between">
                                    <span
                                        class="text-[11px] font-bold <?php echo e($cell['in_month'] ? 'text-gray-700 dark:text-gray-200' : 'text-gray-400 dark:text-gray-500'); ?> <?php echo e($cell['is_today'] ? 'text-maroon dark:text-red-200' : ''); ?>"><?php echo e($cell['date']->format('j')); ?></span>
                                    <?php if($eventCount > 0): ?>
                                        <button type="button" @click.stop="open = !open"
                                            class="inline-flex items-center gap-1 rounded-full border border-maroon/20 bg-maroon/10 px-1.5 py-0.5"
                                            title="Lihat agenda">
                                            <?php for($i = 0; $i < min($eventCount, 3); $i++): ?>
                                ...
                                <?php if($eventCount > 0): ?>
                                    <div x-show="open" x-cloak @click.outside="open = false"
                                        ...
                                        <p class="text-[10px] font-bold text-maroon uppercase tracking-wide mb-1">
                                            <?php echo e($cell['date']->translatedFormat('d M Y')); ?></p>
                                        <div class="space-y-1.5">
                                            <?php $__currentLoopData = collect($cell['events'])->take(3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $eventItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <div class="text-[10px] text-gray-700 dark:text-gray-200 leading-tight">
                                                    ...
                                                    <span class="break-words"><?php echo e($eventItem->title ?? $eventItem->name ?? 'Agenda'); ?></span>
                                                </div>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            <?php if($eventCount > 3): ?>
                                                <p class="text-[10px] font-semibold text-gray-500 dark:text-gray-400">+<?php echo e($eventCount - 3); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/naradata/STIH-SIAKAD/resources/views/admin/dashboard.blade.php ENDPATH**/ ?>