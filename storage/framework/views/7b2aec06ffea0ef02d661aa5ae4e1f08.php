<?php $__env->startSection('title', 'Konfirmasi KRS'); ?>
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
                    <div class="p-6 flex flex-col items-center border-b border-gray-100">
                        <div
                            ...
                            <?php $foto = $mahasiswa->foto ?? null; ?>
                            <?php if(!empty($foto)): ?>
                                <img src="<?php echo e($mahasiswa->foto_url ?? ''); ?>" alt="Profile" class="w-full h-full object-cover">
                            <?php else: ?>
                                <i class="fas fa-user text-4xl text-gray-300"></i>
                            <?php endif; ?>
                        </div>
                        <h3 class="text-lg font-bold text-gray-900 text-center leading-tight mb-1">
                            <?php echo e($mahasiswa->nama ?? $mahasiswa->user->name ?? '-'); ?>

                        </h3>
                        <p class="text-sm text-gray-500 font-medium"><?php echo e($mahasiswa->nim ?? ($mahasiswa->user->nim ?? '-')); ?>
                    ...
                    <div class="p-6 space-y-4 bg-gray-50/50">
                        <div>
                            ...
                            <p class="text-sm font-semibold text-gray-800"><?php echo e($mahasiswa->prodi ?? '-'); ?></p>
                        </div>
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                <p class="text-[10px] font-bold text-gray-400 uppercase tracking-wider mb-1">Angkatan</p>
                                <p class="text-sm font-semibold text-gray-800"><?php echo e($mahasiswa->angkatan ?? '-'); ?></p>
                            </div>
                            <div>
                    ...
                    <div class="relative z-10">
                        <div class="mb-8">
                            ...
                            <h2 class="text-3xl font-bold text-gray-900 capitalize mb-1">
                                Semester <?php echo e($semesterAktif->semester_number ?? 1); ?>

                            </h2>
                            <p class="text-gray-500">
                                <?php echo e($semesterAktif->nama_semester ?? 'Ganjil'); ?> <?php echo e($semesterAktif->tahun_ajaran); ?>
                        ...
                        <?php if(isset($alreadySubmitted) && $alreadySubmitted): ?>
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-auto">
                                <a href="<?php echo e(route('mahasiswa.krs.index', ['view_only' => 1])); ?>"
                        ...
                        <?php elseif(isset($hasDraft) && $hasDraft): ?>
                        ...
                        <?php else: ?>
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-auto">
                                <a href="<?php echo e(route('mahasiswa.krs.index')); ?>?start=1"
                    ...
                    <table class="w-full min-w-[700px] divide-y divide-gray-200 dark:divide-slate-700">
                        <thead class="bg-gray-50 dark:bg-slate-800">
                            <tr>
                                ...
                                <th scope="col" class="px-6 py-4 text-center text-xs font-bold text-gray-500 dark:text-slate-400 uppercase tracking-wider whitespace-nowrap w-full">
                                    Tahun Ajaran
                                </th>
                        ...
                        <tbody class="bg-white dark:bg-[#1a1d2e] divide-y divide-gray-200 dark:divide-slate-700">
                            <?php $__empty_1 = true; $__currentLoopData = $semesterList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <?php
                                ...
                                <tr class="hover:bg-gray-50 dark:hover:bg-slate-800/50 transition-colors">
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-semibold text-gray-900 dark:text-white capitalize">
                                        Semester <?php echo e($sem->semester_number ?? 1); ?>

                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-center text-gray-600 dark:text-slate-300">
                        ...
                        <?php $__empty_1 = true; $__currentLoopData = $semesterList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            ...
                            <div class="p-5 space-y-4 hover:bg-gray-50 dark:hover:bg-slate-800/50 transition-colors">
                                <div class="flex justify-between items-start">
                                    <div>
                                        <h4 class="text-base font-bold text-gray-900 dark:text-white">Semester <?php echo e($sem->semester_number ?? 1); ?></h4>
                                        <div class="flex items-center gap-2 mt-1">
                                            <span class="px-2 py-0.5 rounded text-[10px] font-bold bg-gray-100 dark:bg-slate-800 text-gray-600 dark:text-slate-400 border border-gray-200 dark:border-slate-700">
                                                TA <?php echo e($sem->tahun_ajaran ?? '-'); ?>
...
<?php echo $__env->make('layouts.mahasiswa', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/naradata/STIH-SIAKAD/resources/views/page/mahasiswa/krs/confirm.blade.php ENDPATH**/ ?>