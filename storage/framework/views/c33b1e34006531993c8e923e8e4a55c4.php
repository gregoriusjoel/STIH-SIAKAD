                        ...
                        <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition duration-200">
                            <td class="px-6 py-4">
                                <div class="flex items-center">
                                    ...
                                    <div class="ml-4">
                                        <div class="font-semibold text-gray-900 dark:text-gray-100"><?php echo e($u->name); ?></div>
                                        <div class="text-sm text-gray-500 dark:text-gray-400">ID: <?php echo e($u->id); ?></div>
                                    </div>
                                </div>
                            </td>
                            <td class="px-6 py-4 dark:text-gray-300"><i
                                    class="fas fa-envelope text-maroon mr-2"></i><?php echo e($u->email); ?></td>
                            <td class="px-6 py-4 text-center">
                                ...
                                <?php elseif($u->role == 'perpustakaan'): ?>
                                    <span
                                ...
                                <?php else: ?>
                                    <span
                                        class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-gray-100 dark:bg-gray-700 text-gray-800 dark:text-gray-300"><i
                                            class="fas fa-user mr-1"></i><?php echo e(ucfirst($u->role)); ?></span>
                                <?php endif; ?>
                            </td>
                            <td class="px-6 py-4 text-center">
                                <div class="flex justify-center space-x-2">
                                    ...
                                    <?php if($u->id != auth()->id()): ?>
                                        <form action="<?php echo e(route('admin.users.destroy', $u)); ?>" method="POST" class="delete-form">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/naradata/STIH-SIAKAD/resources/views/admin/users/index.blade.php ENDPATH**/ ?>