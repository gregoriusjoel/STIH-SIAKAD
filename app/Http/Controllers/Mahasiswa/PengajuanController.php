...
class PengajuanController extends Controller
{
    ...
    public function downloadGenerated(Pengajuan $pengajuan)
    {
        ...
        return Storage::disk(\App\Helpers\FileHelper::resolveDiskForPath($pengajuan->generated_doc_path))->download(
    ...
    public function download(Pengajuan $pengajuan)
    {
        ...
        return Storage::disk(\App\Helpers\FileHelper::resolveDiskForPath($pengajuan->file_surat))->download(
    ...
    public function preview(Pengajuan $pengajuan)
    {
        ...
        return Storage::disk(\App\Helpers\FileHelper::resolveDiskForPath($pengajuan->file_surat))->response(
            $pengajuan->file_surat,
            'preview.pdf',
