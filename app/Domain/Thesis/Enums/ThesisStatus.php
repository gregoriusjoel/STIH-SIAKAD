...
namespace App\Domain\Thesis\Enums;
...
enum ThesisStatus: string
{
    ...
    // Final
    case THESIS_COMPLETED    = 'THESIS_COMPLETED';
    ...
    public function label(): string
    {
        return match($this) {
            ...
            self::THESIS_COMPLETED    => 'Skripsi Selesai',
        };
    }
    ...
    public function allowedTransitions(): array
    {
        return match($this) {
            ...
            self::REVISION_APPROVED   => [self::THESIS_COMPLETED],
            self::THESIS_COMPLETED    => [],
        };
    }
